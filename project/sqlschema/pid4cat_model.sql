...
-- # Class: "HdlDataUrl" Description: "The data element in the handle API for the redirect url."
--     * Slot: id Description:
--     * Slot: format Description: The format of the handle data.
--     * Slot: value Description: The value of the handle data.
-- # Class: "STATUS" Description: "A data element in the handle API."
--     * Slot: id Description:
--     * Slot: index Description: The index of the handle record.
--     * Slot: ttl Description: A time to live in seconds for the handle record. Typically: 86400 => 1 dayTODO: Research details of ttl meaning for handle API.
--     * Slot: timestamp Description: The iso datetime for the last update of the handle data.
--     * Slot: type Description: The type of handledata stored in the handle record.
--     * Slot: data_id Description: The data in the handle record.
-- # Class: "HdlDataStatus" Description: "The data element in the handle API for the status."
--     * Slot: id Description:
--     * Slot: format Description: The format of the handle data.
--     * Slot: value Description: The value of the handle data.
...
--     * Slot: type Description: The type of handledata stored in the handle record.
--     * Slot: data_id Description: The data in the handle record.
-- # Class: "HdlDataSchemaVer" Description: "The data element in the handle API for the schema version."
--     * Slot: id Description:
--     * Slot: format Description: The format of the handle data.
--     * Slot: value Description: The value of the handle data.
-- # Class: "LICENSE" Description: "The data element in the handle API for the schema version."
--     * Slot: id Description:
--     * Slot: index Description: The index of the handle record.
--     * Slot: ttl Description: A time to live in seconds for the handle record. Typically: 86400 => 1 dayTODO: Research details of ttl meaning for handle API.
--     * Slot: timestamp Description: The iso datetime for the last update of the handle data.
--     * Slot: type Description: The type of handledata stored in the handle record.
--     * Slot: data_id Description: The data in the handle record.
-- # Class: "HdlDataLicense" Description: "The data element in the handle API for the license."
--     * Slot: id Description:
--     * Slot: format Description: The format of the handle data.
--     * Slot: value Description: The value of the handle data.
...
--     * Slot: type Description: The type of handledata stored in the handle record.
--     * Slot: data_id Description: The data in the handle record.
-- # Class: "HdlDataContact" Description: "The data element in the handle API for the contact email."
--     * Slot: id Description:
--     * Slot: format Description: The format of the handle data.
--     * Slot: value Description: The value of the handle data.
...
--     * Slot: type Description: The type of handledata stored in the handle record.
--     * Slot: data_id Description: The data in the handle record.
-- # Class: "HdlDataResourceInfo" Description: "The data element in the handle API for the resource info."
--     * Slot: id Description:
--     * Slot: format Description: The format of the handle data.
...
--     * Slot: type Description: The type of handledata stored in the handle record.
--     * Slot: data_id Description: The data in the handle record.
-- # Class: "HdlDataRelated" Description: "The data element in the handle API for related identifiers."
--     * Slot: id Description:
--     * Slot: format Description: The format of the handle data.
...
--     * Slot: type Description: The type of handledata stored in the handle record.
--     * Slot: data_id Description: The data in the handle record.
-- # Class: "HdlDataLog" Description: "The data element in the handle API for the change log."
--     * Slot: id Description:
--     * Slot: format Description: The format of the handle data.
...
-- # Class: "RelatedIdentifier" Description: "A class for all types pf related identifiers."
--     * Slot: id Description:
