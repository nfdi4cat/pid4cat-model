...
class MEDIATypes(str, Enum):
    ...
    applicationSOLIDUS3gpdash_qoe_reportPLUS_SIGNxml = "application/3gpdash-qoe-report+xml"
    ...
    applicationSOLIDUSalto_costmapfilterPLUS_SIGNjson = "application/alto-costmapfilter+json"
    applicationSOLIDUSalto_directoryPLUS_SIGNjson = "application/alto-directory+json"
    applicationSOLIDUSalto_endpointcostPLUS_SIGNjson = "application/alto-endpointcost+json"
    applicationSOLIDUSalto_endpointcostparamsPLUS_SIGNjson = "application/alto-endpointcostparams+json"
    applicationSOLIDUSalto_endpointpropPLUS_SIGNjson = "application/alto-endpointprop+json"
    applicationSOLIDUSalto_endpointpropparamsPLUS_SIGNjson = "application/alto-endpointpropparams+json"
    ...
    applicationSOLIDUSalto_networkmapfilterPLUS_SIGNjson = "application/alto-networkmapfilter+json"
    applicationSOLIDUSalto_propmapPLUS_SIGNjson = "application/alto-propmap+json"
    applicationSOLIDUSalto_propmapparamsPLUS_SIGNjson = "application/alto-propmapparams+json"
    ...
    applicationSOLIDUSalto_updatestreamcontrolPLUS_SIGNjson = "application/alto-updatestreamcontrol+json"
    applicationSOLIDUSalto_updatestreamparamsPLUS_SIGNjson = "application/alto-updatestreamparams+json"
    ...
    applicationSOLIDUSatsc_dynamic_event_message = "application/atsc-dynamic-event-message"
    ...
    applicationSOLIDUSautomationml_amlxPLUS_SIGNzip = "application/automationml-amlx+zip"
    ...
    applicationSOLIDUSconcise_problem_detailsPLUS_SIGNcbor = "application/concise-problem-details+cbor"
    ...
    applicationSOLIDUSEmergencyCallDataFULL_STOPcapPLUS_SIGNxml = "application/EmergencyCallData.cap+xml"
    applicationSOLIDUSEmergencyCallDataFULL_STOPCommentPLUS_SIGNxml = "application/EmergencyCallData.Comment+xml"
    applicationSOLIDUSEmergencyCallDataFULL_STOPControlPLUS_SIGNxml = "application/EmergencyCallData.Control+xml"
    applicationSOLIDUSEmergencyCallDataFULL_STOPDeviceInfoPLUS_SIGNxml = "application/EmergencyCallData.DeviceInfo+xml"
    applicationSOLIDUSEmergencyCallDataFULL_STOPeCallFULL_STOPMSD = "application/EmergencyCallData.eCall.MSD"
    applicationSOLIDUSEmergencyCallDataFULL_STOPLegacyESNPLUS_SIGNjson = "application/EmergencyCallData.LegacyESN+json"
    applicationSOLIDUSEmergencyCallDataFULL_STOPProviderInfoPLUS_SIGNxml = "application/EmergencyCallData.ProviderInfo+xml"
    applicationSOLIDUSEmergencyCallDataFULL_STOPServiceInfoPLUS_SIGNxml = "application/EmergencyCallData.ServiceInfo+xml"
    applicationSOLIDUSEmergencyCallDataFULL_STOPSubscriberInfoPLUS_SIGNxml = "application/EmergencyCallData.SubscriberInfo+xml"
    applicationSOLIDUSEmergencyCallDataFULL_STOPVEDSPLUS_SIGNxml = "application/EmergencyCallData.VEDS+xml"
    ...
    applicationSOLIDUSexpect_ct_reportPLUS_SIGNjson = "application/expect-ct-report+json"
    ...
    applicationSOLIDUSframework_attributesPLUS_SIGNxml = "application/framework-attributes+xml"
    ...
    applicationSOLIDUSgnap_binding_rotation_jws = "application/gnap-binding-rotation-jws"
    applicationSOLIDUSgnap_binding_rotation_jwsd = "application/gnap-binding-rotation-jwsd"
    ...
    applicationSOLIDUSmathml_presentationPLUS_SIGNxml = "application/mathml-presentation+xml"
    applicationSOLIDUSmbms_associated_procedure_descriptionPLUS_SIGNxml = "application/mbms-associated-procedure-description+xml"
    ...
    applicationSOLIDUSmbms_msk_responsePLUS_SIGNxml = "application/mbms-msk-response+xml"
    applicationSOLIDUSmbms_protection_descriptionPLUS_SIGNxml = "application/mbms-protection-description+xml"
    applicationSOLIDUSmbms_reception_reportPLUS_SIGNxml = "application/mbms-reception-report+xml"
    applicationSOLIDUSmbms_registerPLUS_SIGNxml = "application/mbms-register+xml"
    applicationSOLIDUSmbms_register_responsePLUS_SIGNxml = "application/mbms-register-response+xml"
    applicationSOLIDUSmbms_schedulePLUS_SIGNxml = "application/mbms-schedule+xml"
    applicationSOLIDUSmbms_user_service_descriptionPLUS_SIGNxml = "application/mbms-user-service-description+xml"
    applicationSOLIDUSmbox = "application/mbox"
    applicationSOLIDUSmedia_controlPLUS_SIGNxml = "application/media_control+xml"
    applicationSOLIDUSmedia_policy_datasetPLUS_SIGNxml = "application/media-policy-dataset+xml"
    applicationSOLIDUSmediaservercontrolPLUS_SIGNxml = "application/mediaservercontrol+xml"
    ...
    applicationSOLIDUSmissing_blocksPLUS_SIGNcbor_seq = "application/missing-blocks+cbor-seq"
    ...
    applicationSOLIDUSprivate_token_issuer_directory = "application/private-token-issuer-directory"
    ...
    applicationSOLIDUSprsFULL_STOPalvestrandFULL_STOPtitrax_sheet = "application/prs.alvestrand.titrax-sheet"
    ...
    applicationSOLIDUSprsFULL_STOPimplied_documentPLUS_SIGNxml = "application/prs.implied-document+xml"
    applicationSOLIDUSprsFULL_STOPimplied_executable = "application/prs.implied-executable"
    applicationSOLIDUSprsFULL_STOPimplied_objectPLUS_SIGNjson = "application/prs.implied-object+json"
    applicationSOLIDUSprsFULL_STOPimplied_objectPLUS_SIGNjson_seq = "application/prs.implied-object+json-seq"
    applicationSOLIDUSprsFULL_STOPimplied_objectPLUS_SIGNyaml = "application/prs.implied-object+yaml"
    applicationSOLIDUSprsFULL_STOPimplied_structure = "application/prs.implied-structure"
    ...
    applicationSOLIDUSresource_lists_diffPLUS_SIGNxml = "application/resource-lists-diff+xml"
    ...
    applicationSOLIDUSsarif_external_propertiesPLUS_SIGNjson = "application/sarif-external-properties+json"
    ...
    applicationSOLIDUSset_registration_initiation = "application/set-registration-initiation"
    ...
    applicationSOLIDUStamp_community_update_confirm = "application/tamp-community-update-confirm"
    ...
    applicationSOLIDUStamp_sequence_adjust_confirm = "application/tamp-sequence-adjust-confirm"
    ...
    applicationSOLIDUStoken_introspectionPLUS_SIGNjwt = "application/token-introspection+jwt"
    ...
    applicationSOLIDUStrust_mark_delegationPLUS_SIGNjwt = "application/trust-mark-delegation+jwt"
    ...
    applicationSOLIDUSvndFULL_STOP1000mindsFULL_STOPdecision_modelPLUS_SIGNxml = "application/vnd.1000minds.decision-model+xml"
    ...
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOP5gsa2x_local_service_information = "application/vnd.3gpp.5gsa2x-local-service-information"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOP5gsv2x = "application/vnd.3gpp.5gsv2x"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOP5gsv2x_local_service_information = "application/vnd.3gpp.5gsv2x-local-service-information"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPaccess_transfer_eventsPLUS_SIGNxml = "application/vnd.3gpp.access-transfer-events+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPbsfPLUS_SIGNxml = "application/vnd.3gpp.bsf+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPcrsPLUS_SIGNxml = "application/vnd.3gpp.crs+xml"
    ...
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPGMOPPLUS_SIGNxml = "application/vnd.3gpp.GMOP+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPgtpc = "application/vnd.3gpp.gtpc"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPinterworking_data = "application/vnd.3gpp.interworking-data"
    ...
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcdata_infoPLUS_SIGNxml = "application/vnd.3gpp.mcdata-info+xml"
    ...
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcdata_payload = "application/vnd.3gpp.mcdata-payload"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcdata_regroupPLUS_SIGNxml = "application/vnd.3gpp.mcdata-regroup+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcdata_service_configPLUS_SIGNxml = "application/vnd.3gpp.mcdata-service-config+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcdata_signalling = "application/vnd.3gpp.mcdata-signalling"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcdata_ue_configPLUS_SIGNxml = "application/vnd.3gpp.mcdata-ue-config+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcdata_user_profilePLUS_SIGNxml = "application/vnd.3gpp.mcdata-user-profile+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcptt_affiliation_commandPLUS_SIGNxml = "application/vnd.3gpp.mcptt-affiliation-command+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcptt_floor_requestPLUS_SIGNxml = "application/vnd.3gpp.mcptt-floor-request+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcptt_infoPLUS_SIGNxml = "application/vnd.3gpp.mcptt-info+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcptt_location_infoPLUS_SIGNxml = "application/vnd.3gpp.mcptt-location-info+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcptt_mbms_usage_infoPLUS_SIGNxml = "application/vnd.3gpp.mcptt-mbms-usage-info+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcptt_regroupPLUS_SIGNxml = "application/vnd.3gpp.mcptt-regroup+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcptt_service_configPLUS_SIGNxml = "application/vnd.3gpp.mcptt-service-config+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcptt_signedPLUS_SIGNxml = "application/vnd.3gpp.mcptt-signed+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcptt_ue_configPLUS_SIGNxml = "application/vnd.3gpp.mcptt-ue-config+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcptt_ue_init_configPLUS_SIGNxml = "application/vnd.3gpp.mcptt-ue-init-config+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcptt_user_profilePLUS_SIGNxml = "application/vnd.3gpp.mcptt-user-profile+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmc_signalling_ear = "application/vnd.3gpp.mc-signalling-ear"
    ...
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcvideo_affiliation_infoPLUS_SIGNxml = "application/vnd.3gpp.mcvideo-affiliation-info+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcvideo_infoPLUS_SIGNxml = "application/vnd.3gpp.mcvideo-info+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcvideo_location_infoPLUS_SIGNxml = "application/vnd.3gpp.mcvideo-location-info+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcvideo_mbms_usage_infoPLUS_SIGNxml = "application/vnd.3gpp.mcvideo-mbms-usage-info+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcvideo_regroupPLUS_SIGNxml = "application/vnd.3gpp.mcvideo-regroup+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcvideo_service_configPLUS_SIGNxml = "application/vnd.3gpp.mcvideo-service-config+xml"
    ...
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcvideo_ue_configPLUS_SIGNxml = "application/vnd.3gpp.mcvideo-ue-config+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmcvideo_user_profilePLUS_SIGNxml = "application/vnd.3gpp.mcvideo-user-profile+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPmid_callPLUS_SIGNxml = "application/vnd.3gpp.mid-call+xml"
    ...
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPpic_bw_large = "application/vnd.3gpp.pic-bw-large"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPpic_bw_small = "application/vnd.3gpp.pic-bw-small"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPpic_bw_var = "application/vnd.3gpp.pic-bw-var"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPpinapp_infoPLUS_SIGNxml = "application/vnd.3gpp.pinapp-info+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPs1ap = "application/vnd.3gpp.s1ap"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPseal_group_docPLUS_SIGNxml = "application/vnd.3gpp.seal-group-doc+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPseal_infoPLUS_SIGNxml = "application/vnd.3gpp.seal-info+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPseal_location_infoPLUS_SIGNxml = "application/vnd.3gpp.seal-location-info+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPseal_mbms_usage_infoPLUS_SIGNxml = "application/vnd.3gpp.seal-mbms-usage-info+xml"
    ...
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPseal_ue_config_infoPLUS_SIGNxml = "application/vnd.3gpp.seal-ue-config-info+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPseal_unicast_infoPLUS_SIGNxml = "application/vnd.3gpp.seal-unicast-info+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPseal_user_profile_infoPLUS_SIGNxml = "application/vnd.3gpp.seal-user-profile-info+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPsms = "application/vnd.3gpp.sms"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPsmsPLUS_SIGNxml = "application/vnd.3gpp.sms+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPsrvcc_extPLUS_SIGNxml = "application/vnd.3gpp.srvcc-ext+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPSRVCC_infoPLUS_SIGNxml = "application/vnd.3gpp.SRVCC-info+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPstate_and_event_infoPLUS_SIGNxml = "application/vnd.3gpp.state-and-event-info+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPussdPLUS_SIGNxml = "application/vnd.3gpp.ussd+xml"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPv2x = "application/vnd.3gpp.v2x"
    applicationSOLIDUSvndFULL_STOP3gppFULL_STOPvae_infoPLUS_SIGNxml = "application/vnd.3gpp.vae-info+xml"
    applicationSOLIDUSvndFULL_STOP3gpp2FULL_STOPbcmcsinfoPLUS_SIGNxml = "application/vnd.3gpp2.bcmcsinfo+xml"
    ...
    applicationSOLIDUSvndFULL_STOP3gpp_prosePLUS_SIGNxml = "application/vnd.3gpp-prose+xml"
    applicationSOLIDUSvndFULL_STOP3gpp_prose_pc3aPLUS_SIGNxml = "application/vnd.3gpp-prose-pc3a+xml"
    applicationSOLIDUSvndFULL_STOP3gpp_prose_pc3achPLUS_SIGNxml = "application/vnd.3gpp-prose-pc3ach+xml"
    applicationSOLIDUSvndFULL_STOP3gpp_prose_pc3chPLUS_SIGNxml = "application/vnd.3gpp-prose-pc3ch+xml"
    applicationSOLIDUSvndFULL_STOP3gpp_prose_pc8PLUS_SIGNxml = "application/vnd.3gpp-prose-pc8+xml"
    applicationSOLIDUSvndFULL_STOP3gpp_v2x_local_service_information = "application/vnd.3gpp-v2x-local-service-information"
    applicationSOLIDUSvndFULL_STOP3lightssoftwareFULL_STOPimagescal = "application/vnd.3lightssoftware.imagescal"
    applicationSOLIDUSvndFULL_STOP3MFULL_STOPPost_it_Notes = "application/vnd.3M.Post-it-Notes"
    applicationSOLIDUSvndFULL_STOPaccpacFULL_STOPsimplyFULL_STOPaso = "application/vnd.accpac.simply.aso"
    applicationSOLIDUSvndFULL_STOPaccpacFULL_STOPsimplyFULL_STOPimp = "application/vnd.accpac.simply.imp"
    applicationSOLIDUSvndFULL_STOPacmFULL_STOPaddressxferPLUS_SIGNjson = "application/vnd.acm.addressxfer+json"
    applicationSOLIDUSvndFULL_STOPacmFULL_STOPchatbotPLUS_SIGNjson = "application/vnd.acm.chatbot+json"
    ...
    applicationSOLIDUSvndFULL_STOPadobeFULL_STOPflashFULL_STOPmovie = "application/vnd.adobe.flash.movie"
    applicationSOLIDUSvndFULL_STOPadobeFULL_STOPformscentralFULL_STOPfcdt = "application/vnd.adobe.formscentral.fcdt"
    applicationSOLIDUSvndFULL_STOPadobeFULL_STOPfxp = "application/vnd.adobe.fxp"
    applicationSOLIDUSvndFULL_STOPadobeFULL_STOPpartial_upload = "application/vnd.adobe.partial-upload"
    applicationSOLIDUSvndFULL_STOPadobeFULL_STOPxdpPLUS_SIGNxml = "application/vnd.adobe.xdp+xml"
    applicationSOLIDUSvndFULL_STOPaetherFULL_STOPimp = "application/vnd.aether.imp"
    applicationSOLIDUSvndFULL_STOPafpcFULL_STOPafplinedata = "application/vnd.afpc.afplinedata"
    applicationSOLIDUSvndFULL_STOPafpcFULL_STOPafplinedata_pagedef = "application/vnd.afpc.afplinedata-pagedef"
    applicationSOLIDUSvndFULL_STOPafpcFULL_STOPcmoca_cmresource = "application/vnd.afpc.cmoca-cmresource"
    applicationSOLIDUSvndFULL_STOPafpcFULL_STOPfoca_charset = "application/vnd.afpc.foca-charset"
    applicationSOLIDUSvndFULL_STOPafpcFULL_STOPfoca_codedfont = "application/vnd.afpc.foca-codedfont"
    applicationSOLIDUSvndFULL_STOPafpcFULL_STOPfoca_codepage = "application/vnd.afpc.foca-codepage"
    applicationSOLIDUSvndFULL_STOPafpcFULL_STOPmodca = "application/vnd.afpc.modca"
    applicationSOLIDUSvndFULL_STOPafpcFULL_STOPmodca_cmtable = "application/vnd.afpc.modca-cmtable"
    applicationSOLIDUSvndFULL_STOPafpcFULL_STOPmodca_formdef = "application/vnd.afpc.modca-formdef"
    applicationSOLIDUSvndFULL_STOPafpcFULL_STOPmodca_mediummap = "application/vnd.afpc.modca-mediummap"
    applicationSOLIDUSvndFULL_STOPafpcFULL_STOPmodca_objectcontainer = "application/vnd.afpc.modca-objectcontainer"
    applicationSOLIDUSvndFULL_STOPafpcFULL_STOPmodca_overlay = "application/vnd.afpc.modca-overlay"
    applicationSOLIDUSvndFULL_STOPafpcFULL_STOPmodca_pagesegment = "application/vnd.afpc.modca-pagesegment"
    ...
    applicationSOLIDUSvndFULL_STOPairzipFULL_STOPfilesecureFULL_STOPazf = "application/vnd.airzip.filesecure.azf"
    applicationSOLIDUSvndFULL_STOPairzipFULL_STOPfilesecureFULL_STOPazs = "application/vnd.airzip.filesecure.azs"
    applicationSOLIDUSvndFULL_STOPamadeusPLUS_SIGNjson = "application/vnd.amadeus+json"
    applicationSOLIDUSvndFULL_STOPamazonFULL_STOPmobi8_ebook = "application/vnd.amazon.mobi8-ebook"
    applicationSOLIDUSvndFULL_STOPamericandynamicsFULL_STOPacc = "application/vnd.americandynamics.acc"
    applicationSOLIDUSvndFULL_STOPamigaFULL_STOPami = "application/vnd.amiga.ami"
    applicationSOLIDUSvndFULL_STOPamundsenFULL_STOPmazePLUS_SIGNxml = "application/vnd.amundsen.maze+xml"
    ...
    applicationSOLIDUSvndFULL_STOPanser_web_certificate_issue_initiation = "application/vnd.anser-web-certificate-issue-initiation"
    applicationSOLIDUSvndFULL_STOPantixFULL_STOPgame_component = "application/vnd.antix.game-component"
    applicationSOLIDUSvndFULL_STOPapacheFULL_STOParrowFULL_STOPfile = "application/vnd.apache.arrow.file"
    applicationSOLIDUSvndFULL_STOPapacheFULL_STOParrowFULL_STOPstream = "application/vnd.apache.arrow.stream"
    applicationSOLIDUSvndFULL_STOPapacheFULL_STOPparquet = "application/vnd.apache.parquet"
    applicationSOLIDUSvndFULL_STOPapacheFULL_STOPthriftFULL_STOPbinary = "application/vnd.apache.thrift.binary"
    applicationSOLIDUSvndFULL_STOPapacheFULL_STOPthriftFULL_STOPcompact = "application/vnd.apache.thrift.compact"
    applicationSOLIDUSvndFULL_STOPapacheFULL_STOPthriftFULL_STOPjson = "application/vnd.apache.thrift.json"
    ...
    applicationSOLIDUSvndFULL_STOPaplextorFULL_STOPwarrpPLUS_SIGNjson = "application/vnd.aplextor.warrp+json"
    applicationSOLIDUSvndFULL_STOPapothekendeFULL_STOPreservationPLUS_SIGNjson = "application/vnd.apothekende.reservation+json"
    applicationSOLIDUSvndFULL_STOPappleFULL_STOPinstallerPLUS_SIGNxml = "application/vnd.apple.installer+xml"
    applicationSOLIDUSvndFULL_STOPappleFULL_STOPkeynote = "application/vnd.apple.keynote"
    applicationSOLIDUSvndFULL_STOPappleFULL_STOPmpegurl = "application/vnd.apple.mpegurl"
    applicationSOLIDUSvndFULL_STOPappleFULL_STOPnumbers = "application/vnd.apple.numbers"
    ...
    applicationSOLIDUSvndFULL_STOParistanetworksFULL_STOPswi = "application/vnd.aristanetworks.swi"
    ...
    applicationSOLIDUSvndFULL_STOPastraea_softwareFULL_STOPiota = "application/vnd.astraea-software.iota"
    ...
    applicationSOLIDUSvndFULL_STOPbalsamiqFULL_STOPbmmlPLUS_SIGNxml = "application/vnd.balsamiq.bmml+xml"
    applicationSOLIDUSvndFULL_STOPbalsamiqFULL_STOPbmpr = "application/vnd.balsamiq.bmpr"
    applicationSOLIDUSvndFULL_STOPbanana_accounting = "application/vnd.banana-accounting"
    applicationSOLIDUSvndFULL_STOPbbfFULL_STOPuspFULL_STOPerror = "application/vnd.bbf.usp.error"
    applicationSOLIDUSvndFULL_STOPbbfFULL_STOPuspFULL_STOPmsg = "application/vnd.bbf.usp.msg"
    applicationSOLIDUSvndFULL_STOPbbfFULL_STOPuspFULL_STOPmsgPLUS_SIGNjson = "application/vnd.bbf.usp.msg+json"
    applicationSOLIDUSvndFULL_STOPbekitzur_stechPLUS_SIGNjson = "application/vnd.bekitzur-stech+json"
    applicationSOLIDUSvndFULL_STOPbelightsoftFULL_STOPlhzdPLUS_SIGNzip = "application/vnd.belightsoft.lhzd+zip"
    applicationSOLIDUSvndFULL_STOPbelightsoftFULL_STOPlhzlPLUS_SIGNzip = "application/vnd.belightsoft.lhzl+zip"
    applicationSOLIDUSvndFULL_STOPbintFULL_STOPmed_content = "application/vnd.bint.med-content"
    applicationSOLIDUSvndFULL_STOPbiopaxFULL_STOPrdfPLUS_SIGNxml = "application/vnd.biopax.rdf+xml"
    applicationSOLIDUSvndFULL_STOPblink_idb_value_wrapper = "application/vnd.blink-idb-value-wrapper"
    applicationSOLIDUSvndFULL_STOPblueiceFULL_STOPmultipass = "application/vnd.blueice.multipass"
    applicationSOLIDUSvndFULL_STOPbluetoothFULL_STOPepFULL_STOPoob = "application/vnd.bluetooth.ep.oob"
    applicationSOLIDUSvndFULL_STOPbluetoothFULL_STOPleFULL_STOPoob = "application/vnd.bluetooth.le.oob"
    ...
    applicationSOLIDUSvndFULL_STOPbyuFULL_STOPuapiPLUS_SIGNjson = "application/vnd.byu.uapi+json"
    applicationSOLIDUSvndFULL_STOPbzip3 = "application/vnd.bzip3"
    applicationSOLIDUSvndFULL_STOPc3vocFULL_STOPschedulePLUS_SIGNxml = "application/vnd.c3voc.schedule+xml"
    ...
    applicationSOLIDUSvndFULL_STOPcapasystems_pgPLUS_SIGNjson = "application/vnd.capasystems-pg+json"
    applicationSOLIDUSvndFULL_STOPcendioFULL_STOPthinlincFULL_STOPclientconf = "application/vnd.cendio.thinlinc.clientconf"
    applicationSOLIDUSvndFULL_STOPcentury_systemsFULL_STOPtcp_stream = "application/vnd.century-systems.tcp_stream"
    ...
    applicationSOLIDUSvndFULL_STOPchipnutsFULL_STOPkaraoke_mmd = "application/vnd.chipnuts.karaoke-mmd"
    ...
    applicationSOLIDUSvndFULL_STOPcirpackFULL_STOPisdn_ext = "application/vnd.cirpack.isdn-ext"
    applicationSOLIDUSvndFULL_STOPcitationstylesFULL_STOPstylePLUS_SIGNxml = "application/vnd.citationstyles.style+xml"
    ...
    applicationSOLIDUSvndFULL_STOPclonkFULL_STOPc4group = "application/vnd.clonk.c4group"
    applicationSOLIDUSvndFULL_STOPcluetrustFULL_STOPcartomobile_config = "application/vnd.cluetrust.cartomobile-config"
    applicationSOLIDUSvndFULL_STOPcluetrustFULL_STOPcartomobile_config_pkg = "application/vnd.cluetrust.cartomobile-config-pkg"
    ...
    applicationSOLIDUSvndFULL_STOPcollabioFULL_STOPxodocumentsFULL_STOPdocument = "application/vnd.collabio.xodocuments.document"
    ...
    applicationSOLIDUSvndFULL_STOPcollabioFULL_STOPxodocumentsFULL_STOPpresentation = "application/vnd.collabio.xodocuments.presentation"
    ...
    applicationSOLIDUSvndFULL_STOPcollabioFULL_STOPxodocumentsFULL_STOPspreadsheet = "application/vnd.collabio.xodocuments.spreadsheet"
    ...
    applicationSOLIDUSvndFULL_STOPcollectionFULL_STOPdocPLUS_SIGNjson = "application/vnd.collection.doc+json"
    applicationSOLIDUSvndFULL_STOPcollectionFULL_STOPnextPLUS_SIGNjson = "application/vnd.collection.next+json"
    applicationSOLIDUSvndFULL_STOPcollectionPLUS_SIGNjson = "application/vnd.collection+json"
    applicationSOLIDUSvndFULL_STOPcomicbookPLUS_SIGNzip = "application/vnd.comicbook+zip"
    applicationSOLIDUSvndFULL_STOPcomicbook_rar = "application/vnd.comicbook-rar"
    applicationSOLIDUSvndFULL_STOPcommerce_battelle = "application/vnd.commerce-battelle"
    ...
    applicationSOLIDUSvndFULL_STOPcoreosFULL_STOPignitionPLUS_SIGNjson = "application/vnd.coreos.ignition+json"
    applicationSOLIDUSvndFULL_STOPcosmocaller = "application/vnd.cosmocaller"
    applicationSOLIDUSvndFULL_STOPcrickFULL_STOPclicker = "application/vnd.crick.clicker"
    applicationSOLIDUSvndFULL_STOPcrickFULL_STOPclickerFULL_STOPkeyboard = "application/vnd.crick.clicker.keyboard"
    applicationSOLIDUSvndFULL_STOPcrickFULL_STOPclickerFULL_STOPpalette = "application/vnd.crick.clicker.palette"
    applicationSOLIDUSvndFULL_STOPcrickFULL_STOPclickerFULL_STOPtemplate = "application/vnd.crick.clicker.template"
    applicationSOLIDUSvndFULL_STOPcrickFULL_STOPclickerFULL_STOPwordbank = "application/vnd.crick.clicker.wordbank"
    applicationSOLIDUSvndFULL_STOPcriticaltoolsFULL_STOPwbsPLUS_SIGNxml = "application/vnd.criticaltools.wbs+xml"
    applicationSOLIDUSvndFULL_STOPcryptiiFULL_STOPpipePLUS_SIGNjson = "application/vnd.cryptii.pipe+json"
    applicationSOLIDUSvndFULL_STOPcryptomatorFULL_STOPencrypted = "application/vnd.cryptomator.encrypted"
    applicationSOLIDUSvndFULL_STOPcryptomatorFULL_STOPvault = "application/vnd.cryptomator.vault"
    applicationSOLIDUSvndFULL_STOPcrypto_shade_file = "application/vnd.crypto-shade-file"
    applicationSOLIDUSvndFULL_STOPctc_posml = "application/vnd.ctc-posml"
    applicationSOLIDUSvndFULL_STOPctctFULL_STOPwsPLUS_SIGNxml = "application/vnd.ctct.ws+xml"
    ...
    applicationSOLIDUSvndFULL_STOPcyanFULL_STOPdeanFULL_STOProotPLUS_SIGNxml = "application/vnd.cyan.dean.root+xml"
    applicationSOLIDUSvndFULL_STOPcybank = "application/vnd.cybank"
    applicationSOLIDUSvndFULL_STOPcyclonedxPLUS_SIGNjson = "application/vnd.cyclonedx+json"
    applicationSOLIDUSvndFULL_STOPcyclonedxPLUS_SIGNxml = "application/vnd.cyclonedx+xml"
    applicationSOLIDUSvndFULL_STOPd2lFULL_STOPcoursepackage1p0PLUS_SIGNzip = "application/vnd.d2l.coursepackage1p0+zip"
    ...
    applicationSOLIDUSvndFULL_STOPdatapackagePLUS_SIGNjson = "application/vnd.datapackage+json"
    applicationSOLIDUSvndFULL_STOPdataresourcePLUS_SIGNjson = "application/vnd.dataresource+json"
    applicationSOLIDUSvndFULL_STOPdata_visionFULL_STOPrdz = "application/vnd.data-vision.rdz"
    ...
    applicationSOLIDUSvndFULL_STOPdebianFULL_STOPbinary_package = "application/vnd.debian.binary-package"
    applicationSOLIDUSvndFULL_STOPdeceFULL_STOPdata = "application/vnd.dece.data"
    applicationSOLIDUSvndFULL_STOPdeceFULL_STOPttmlPLUS_SIGNxml = "application/vnd.dece.ttml+xml"
    applicationSOLIDUSvndFULL_STOPdeceFULL_STOPunspecified = "application/vnd.dece.unspecified"
    applicationSOLIDUSvndFULL_STOPdeceFULL_STOPzip = "application/vnd.dece.zip"
    applicationSOLIDUSvndFULL_STOPdenovoFULL_STOPfcselayout_link = "application/vnd.denovo.fcselayout-link"
    applicationSOLIDUSvndFULL_STOPdesmumeFULL_STOPmovie = "application/vnd.desmume.movie"
    applicationSOLIDUSvndFULL_STOPdir_biFULL_STOPplate_dl_nosuffix = "application/vnd.dir-bi.plate-dl-nosuffix"
    applicationSOLIDUSvndFULL_STOPdmFULL_STOPdelegationPLUS_SIGNxml = "application/vnd.dm.delegation+xml"
    applicationSOLIDUSvndFULL_STOPdna = "application/vnd.dna"
    applicationSOLIDUSvndFULL_STOPdocumentPLUS_SIGNjson = "application/vnd.document+json"
    applicationSOLIDUSvndFULL_STOPdolbyFULL_STOPmobileFULL_STOP1 = "application/vnd.dolby.mobile.1"
    applicationSOLIDUSvndFULL_STOPdolbyFULL_STOPmobileFULL_STOP2 = "application/vnd.dolby.mobile.2"
    applicationSOLIDUSvndFULL_STOPdoremirFULL_STOPscorecloud_binary_document = "application/vnd.doremir.scorecloud-binary-document"
    ...
    applicationSOLIDUSvndFULL_STOPdtgFULL_STOPlocalFULL_STOPflash = "application/vnd.dtg.local.flash"
    applicationSOLIDUSvndFULL_STOPdtgFULL_STOPlocalFULL_STOPhtml = "application/vnd.dtg.local.html"
    applicationSOLIDUSvndFULL_STOPdvbFULL_STOPait = "application/vnd.dvb.ait"
    applicationSOLIDUSvndFULL_STOPdvbFULL_STOPdvbislPLUS_SIGNxml = "application/vnd.dvb.dvbisl+xml"
    applicationSOLIDUSvndFULL_STOPdvbFULL_STOPdvbj = "application/vnd.dvb.dvbj"
    applicationSOLIDUSvndFULL_STOPdvbFULL_STOPesgcontainer = "application/vnd.dvb.esgcontainer"
    applicationSOLIDUSvndFULL_STOPdvbFULL_STOPipdcdftnotifaccess = "application/vnd.dvb.ipdcdftnotifaccess"
    applicationSOLIDUSvndFULL_STOPdvbFULL_STOPipdcesgaccess = "application/vnd.dvb.ipdcesgaccess"
    applicationSOLIDUSvndFULL_STOPdvbFULL_STOPipdcesgaccess2 = "application/vnd.dvb.ipdcesgaccess2"
    applicationSOLIDUSvndFULL_STOPdvbFULL_STOPipdcesgpdd = "application/vnd.dvb.ipdcesgpdd"
    applicationSOLIDUSvndFULL_STOPdvbFULL_STOPipdcroaming = "application/vnd.dvb.ipdcroaming"
    applicationSOLIDUSvndFULL_STOPdvbFULL_STOPiptvFULL_STOPalfec_base = "application/vnd.dvb.iptv.alfec-base"
    applicationSOLIDUSvndFULL_STOPdvbFULL_STOPiptvFULL_STOPalfec_enhancement = "application/vnd.dvb.iptv.alfec-enhancement"
    applicationSOLIDUSvndFULL_STOPdvbFULL_STOPnotif_aggregate_rootPLUS_SIGNxml = "application/vnd.dvb.notif-aggregate-root+xml"
    applicationSOLIDUSvndFULL_STOPdvbFULL_STOPnotif_containerPLUS_SIGNxml = "application/vnd.dvb.notif-container+xml"
    applicationSOLIDUSvndFULL_STOPdvbFULL_STOPnotif_genericPLUS_SIGNxml = "application/vnd.dvb.notif-generic+xml"
    applicationSOLIDUSvndFULL_STOPdvbFULL_STOPnotif_ia_msglistPLUS_SIGNxml = "application/vnd.dvb.notif-ia-msglist+xml"
    ...
    applicationSOLIDUSvndFULL_STOPdvbFULL_STOPnotif_initPLUS_SIGNxml = "application/vnd.dvb.notif-init+xml"
    ...
    applicationSOLIDUSvndFULL_STOPeasykaraokeFULL_STOPcdgdownload = "application/vnd.easykaraoke.cdgdownload"
    ...
    applicationSOLIDUSvndFULL_STOPeclipseFULL_STOPdittoPLUS_SIGNjson = "application/vnd.eclipse.ditto+json"
    applicationSOLIDUSvndFULL_STOPecowinFULL_STOPchart = "application/vnd.ecowin.chart"
    applicationSOLIDUSvndFULL_STOPecowinFULL_STOPfilerequest = "application/vnd.ecowin.filerequest"
    applicationSOLIDUSvndFULL_STOPecowinFULL_STOPfileupdate = "application/vnd.ecowin.fileupdate"
    applicationSOLIDUSvndFULL_STOPecowinFULL_STOPseries = "application/vnd.ecowin.series"
    applicationSOLIDUSvndFULL_STOPecowinFULL_STOPseriesrequest = "application/vnd.ecowin.seriesrequest"
    applicationSOLIDUSvndFULL_STOPecowinFULL_STOPseriesupdate = "application/vnd.ecowin.seriesupdate"
    ...
    applicationSOLIDUSvndFULL_STOPemclientFULL_STOPaccessrequestPLUS_SIGNxml = "application/vnd.emclient.accessrequest+xml"
    applicationSOLIDUSvndFULL_STOPenliven = "application/vnd.enliven"
    applicationSOLIDUSvndFULL_STOPenphaseFULL_STOPenvoy = "application/vnd.enphase.envoy"
    applicationSOLIDUSvndFULL_STOPeprintsFULL_STOPdataPLUS_SIGNxml = "application/vnd.eprints.data+xml"
    ...
    applicationSOLIDUSvndFULL_STOPepsonFULL_STOPquickanime = "application/vnd.epson.quickanime"
    ...
    applicationSOLIDUSvndFULL_STOPericssonFULL_STOPquickcall = "application/vnd.ericsson.quickcall"
    applicationSOLIDUSvndFULL_STOPerofs = "application/vnd.erofs"
    applicationSOLIDUSvndFULL_STOPespass_espassPLUS_SIGNzip = "application/vnd.espass-espass+zip"
    applicationSOLIDUSvndFULL_STOPeszigno3PLUS_SIGNxml = "application/vnd.eszigno3+xml"
    applicationSOLIDUSvndFULL_STOPetsiFULL_STOPaocPLUS_SIGNxml = "application/vnd.etsi.aoc+xml"
    applicationSOLIDUSvndFULL_STOPetsiFULL_STOPasic_ePLUS_SIGNzip = "application/vnd.etsi.asic-e+zip"
    applicationSOLIDUSvndFULL_STOPetsiFULL_STOPasic_sPLUS_SIGNzip = "application/vnd.etsi.asic-s+zip"
    applicationSOLIDUSvndFULL_STOPetsiFULL_STOPcugPLUS_SIGNxml = "application/vnd.etsi.cug+xml"
    applicationSOLIDUSvndFULL_STOPetsiFULL_STOPiptvcommandPLUS_SIGNxml = "application/vnd.etsi.iptvcommand+xml"
    applicationSOLIDUSvndFULL_STOPetsiFULL_STOPiptvdiscoveryPLUS_SIGNxml = "application/vnd.etsi.iptvdiscovery+xml"
    applicationSOLIDUSvndFULL_STOPetsiFULL_STOPiptvprofilePLUS_SIGNxml = "application/vnd.etsi.iptvprofile+xml"
    applicationSOLIDUSvndFULL_STOPetsiFULL_STOPiptvsad_bcPLUS_SIGNxml = "application/vnd.etsi.iptvsad-bc+xml"
    applicationSOLIDUSvndFULL_STOPetsiFULL_STOPiptvsad_codPLUS_SIGNxml = "application/vnd.etsi.iptvsad-cod+xml"
    applicationSOLIDUSvndFULL_STOPetsiFULL_STOPiptvsad_npvrPLUS_SIGNxml = "application/vnd.etsi.iptvsad-npvr+xml"
    applicationSOLIDUSvndFULL_STOPetsiFULL_STOPiptvservicePLUS_SIGNxml = "application/vnd.etsi.iptvservice+xml"
    applicationSOLIDUSvndFULL_STOPetsiFULL_STOPiptvsyncPLUS_SIGNxml = "application/vnd.etsi.iptvsync+xml"
    applicationSOLIDUSvndFULL_STOPetsiFULL_STOPiptvueprofilePLUS_SIGNxml = "application/vnd.etsi.iptvueprofile+xml"
    applicationSOLIDUSvndFULL_STOPetsiFULL_STOPmcidPLUS_SIGNxml = "application/vnd.etsi.mcid+xml"
    ...
    applicationSOLIDUSvndFULL_STOPetsiFULL_STOPpstnPLUS_SIGNxml = "application/vnd.etsi.pstn+xml"
    applicationSOLIDUSvndFULL_STOPetsiFULL_STOPsciPLUS_SIGNxml = "application/vnd.etsi.sci+xml"
    applicationSOLIDUSvndFULL_STOPetsiFULL_STOPsimservsPLUS_SIGNxml = "application/vnd.etsi.simservs+xml"
    applicationSOLIDUSvndFULL_STOPetsiFULL_STOPtimestamp_token = "application/vnd.etsi.timestamp-token"
    applicationSOLIDUSvndFULL_STOPetsiFULL_STOPtslFULL_STOPder = "application/vnd.etsi.tsl.der"
    applicationSOLIDUSvndFULL_STOPetsiFULL_STOPtslPLUS_SIGNxml = "application/vnd.etsi.tsl+xml"
    applicationSOLIDUSvndFULL_STOPeuFULL_STOPkasparianFULL_STOPcarPLUS_SIGNjson = "application/vnd.eu.kasparian.car+json"
    applicationSOLIDUSvndFULL_STOPeudoraFULL_STOPdata = "application/vnd.eudora.data"
    applicationSOLIDUSvndFULL_STOPevolvFULL_STOPecigFULL_STOPprofile = "application/vnd.evolv.ecig.profile"
    applicationSOLIDUSvndFULL_STOPevolvFULL_STOPecigFULL_STOPsettings = "application/vnd.evolv.ecig.settings"
    applicationSOLIDUSvndFULL_STOPevolvFULL_STOPecigFULL_STOPtheme = "application/vnd.evolv.ecig.theme"
    applicationSOLIDUSvndFULL_STOPexstream_empowerPLUS_SIGNzip = "application/vnd.exstream-empower+zip"
    ...
    applicationSOLIDUSvndFULL_STOPfamilysearchFULL_STOPgedcomPLUS_SIGNzip = "application/vnd.familysearch.gedcom+zip"
    applicationSOLIDUSvndFULL_STOPfastcopy_disk_image = "application/vnd.fastcopy-disk-image"
    ...
    applicationSOLIDUSvndFULL_STOPfdsnFULL_STOPstationxmlPLUS_SIGNxml = "application/vnd.fdsn.stationxml+xml"
    applicationSOLIDUSvndFULL_STOPffsns = "application/vnd.ffsns"
    applicationSOLIDUSvndFULL_STOPficlabFULL_STOPflbPLUS_SIGNzip = "application/vnd.ficlab.flb+zip"
    ...
    applicationSOLIDUSvndFULL_STOPfiremonkeysFULL_STOPcloudcell = "application/vnd.firemonkeys.cloudcell"
    applicationSOLIDUSvndFULL_STOPFloGraphIt = "application/vnd.FloGraphIt"
    applicationSOLIDUSvndFULL_STOPfluxtimeFULL_STOPclip = "application/vnd.fluxtime.clip"
    applicationSOLIDUSvndFULL_STOPfont_fontforge_sfd = "application/vnd.font-fontforge-sfd"
    applicationSOLIDUSvndFULL_STOPframemaker = "application/vnd.framemaker"
    applicationSOLIDUSvndFULL_STOPfreelogFULL_STOPcomic = "application/vnd.freelog.comic"
    ...
    applicationSOLIDUSvndFULL_STOPfscFULL_STOPweblaunch = "application/vnd.fsc.weblaunch"
    applicationSOLIDUSvndFULL_STOPf_secureFULL_STOPmobile = "application/vnd.f-secure.mobile"
    applicationSOLIDUSvndFULL_STOPfujifilmFULL_STOPfbFULL_STOPdocuworks = "application/vnd.fujifilm.fb.docuworks"
    ...
    applicationSOLIDUSvndFULL_STOPfujifilmFULL_STOPfbFULL_STOPjfiPLUS_SIGNxml = "application/vnd.fujifilm.fb.jfi+xml"
    applicationSOLIDUSvndFULL_STOPfujitsuFULL_STOPoasys = "application/vnd.fujitsu.oasys"
    applicationSOLIDUSvndFULL_STOPfujitsuFULL_STOPoasys2 = "application/vnd.fujitsu.oasys2"
    applicationSOLIDUSvndFULL_STOPfujitsuFULL_STOPoasys3 = "application/vnd.fujitsu.oasys3"
    applicationSOLIDUSvndFULL_STOPfujitsuFULL_STOPoasysgp = "application/vnd.fujitsu.oasysgp"
    applicationSOLIDUSvndFULL_STOPfujitsuFULL_STOPoasysprs = "application/vnd.fujitsu.oasysprs"
    applicationSOLIDUSvndFULL_STOPfujixeroxFULL_STOPART4 = "application/vnd.fujixerox.ART4"
    applicationSOLIDUSvndFULL_STOPfujixeroxFULL_STOPART_EX = "application/vnd.fujixerox.ART-EX"
    applicationSOLIDUSvndFULL_STOPfujixeroxFULL_STOPddd = "application/vnd.fujixerox.ddd"
    applicationSOLIDUSvndFULL_STOPfujixeroxFULL_STOPdocuworks = "application/vnd.fujixerox.docuworks"
    applicationSOLIDUSvndFULL_STOPfujixeroxFULL_STOPdocuworksFULL_STOPbinder = "application/vnd.fujixerox.docuworks.binder"
    applicationSOLIDUSvndFULL_STOPfujixeroxFULL_STOPdocuworksFULL_STOPcontainer = "application/vnd.fujixerox.docuworks.container"
    applicationSOLIDUSvndFULL_STOPfujixeroxFULL_STOPHBPL = "application/vnd.fujixerox.HBPL"
    ...
    applicationSOLIDUSvndFULL_STOPga4ghFULL_STOPpassportPLUS_SIGNjwt = "application/vnd.ga4gh.passport+jwt"
    applicationSOLIDUSvndFULL_STOPgenomatixFULL_STOPtuxedo = "application/vnd.genomatix.tuxedo"
    applicationSOLIDUSvndFULL_STOPgenozip = "application/vnd.genozip"
    applicationSOLIDUSvndFULL_STOPgenticsFULL_STOPgrdPLUS_SIGNjson = "application/vnd.gentics.grd+json"
    applicationSOLIDUSvndFULL_STOPgentooFULL_STOPcatmetadataPLUS_SIGNxml = "application/vnd.gentoo.catmetadata+xml"
    applicationSOLIDUSvndFULL_STOPgentooFULL_STOPebuild = "application/vnd.gentoo.ebuild"
    applicationSOLIDUSvndFULL_STOPgentooFULL_STOPeclass = "application/vnd.gentoo.eclass"
    applicationSOLIDUSvndFULL_STOPgentooFULL_STOPgpkg = "application/vnd.gentoo.gpkg"
    applicationSOLIDUSvndFULL_STOPgentooFULL_STOPmanifest = "application/vnd.gentoo.manifest"
    applicationSOLIDUSvndFULL_STOPgentooFULL_STOPpkgmetadataPLUS_SIGNxml = "application/vnd.gentoo.pkgmetadata+xml"
    ...
    applicationSOLIDUSvndFULL_STOPgeogebraFULL_STOPfile = "application/vnd.geogebra.file"
    applicationSOLIDUSvndFULL_STOPgeogebraFULL_STOPpinboard = "application/vnd.geogebra.pinboard"
    applicationSOLIDUSvndFULL_STOPgeogebraFULL_STOPslides = "application/vnd.geogebra.slides"
    applicationSOLIDUSvndFULL_STOPgeogebraFULL_STOPtool = "application/vnd.geogebra.tool"
    applicationSOLIDUSvndFULL_STOPgeometry_explorer = "application/vnd.geometry-explorer"
    ...
    applicationSOLIDUSvndFULL_STOPglobalplatformFULL_STOPcard_content_mgt = "application/vnd.globalplatform.card-content-mgt"
    applicationSOLIDUSvndFULL_STOPglobalplatformFULL_STOPcard_content_mgt_response = "application/vnd.globalplatform.card-content-mgt-response"
    applicationSOLIDUSvndFULL_STOPgmx = "application/vnd.gmx"
    applicationSOLIDUSvndFULL_STOPgnuFULL_STOPtalerFULL_STOPexchangePLUS_SIGNjson = "application/vnd.gnu.taler.exchange+json"
    applicationSOLIDUSvndFULL_STOPgnuFULL_STOPtalerFULL_STOPmerchantPLUS_SIGNjson = "application/vnd.gnu.taler.merchant+json"
    applicationSOLIDUSvndFULL_STOPgoogle_earthFULL_STOPkmlPLUS_SIGNxml = "application/vnd.google-earth.kml+xml"
    applicationSOLIDUSvndFULL_STOPgoogle_earthFULL_STOPkmz = "application/vnd.google-earth.kmz"
    applicationSOLIDUSvndFULL_STOPgovFULL_STOPskFULL_STOPe_formPLUS_SIGNxml = "application/vnd.gov.sk.e-form+xml"
    applicationSOLIDUSvndFULL_STOPgovFULL_STOPskFULL_STOPe_formPLUS_SIGNzip = "application/vnd.gov.sk.e-form+zip"
    ...
    applicationSOLIDUSvndFULL_STOPgpxseeFULL_STOPmapPLUS_SIGNxml = "application/vnd.gpxsee.map+xml"
    ...
    applicationSOLIDUSvndFULL_STOPgroove_identity_message = "application/vnd.groove-identity-message"
    applicationSOLIDUSvndFULL_STOPgroove_injector = "application/vnd.groove-injector"
    applicationSOLIDUSvndFULL_STOPgroove_tool_message = "application/vnd.groove-tool-message"
    applicationSOLIDUSvndFULL_STOPgroove_tool_template = "application/vnd.groove-tool-template"
    ...
    applicationSOLIDUSvndFULL_STOPHandHeld_EntertainmentPLUS_SIGNxml = "application/vnd.HandHeld-Entertainment+xml"
    ...
    applicationSOLIDUSvndFULL_STOPhheFULL_STOPlesson_player = "application/vnd.hhe.lesson-player"
    ...
    applicationSOLIDUSvndFULL_STOPhydrostatixFULL_STOPsof_data = "application/vnd.hydrostatix.sof-data"
    applicationSOLIDUSvndFULL_STOPhyperPLUS_SIGNjson = "application/vnd.hyper+json"
    applicationSOLIDUSvndFULL_STOPhyperdrivePLUS_SIGNjson = "application/vnd.hyperdrive+json"
    applicationSOLIDUSvndFULL_STOPhyper_itemPLUS_SIGNjson = "application/vnd.hyper-item+json"
    applicationSOLIDUSvndFULL_STOPhzn_3d_crossword = "application/vnd.hzn-3d-crossword"
    applicationSOLIDUSvndFULL_STOPibmFULL_STOPafplinedata = "application/vnd.ibm.afplinedata"
    applicationSOLIDUSvndFULL_STOPibmFULL_STOPelectronic_media = "application/vnd.ibm.electronic-media"
    ...
    applicationSOLIDUSvndFULL_STOPibmFULL_STOPrights_management = "application/vnd.ibm.rights-management"
    applicationSOLIDUSvndFULL_STOPibmFULL_STOPsecure_container = "application/vnd.ibm.secure-container"
    ...
    applicationSOLIDUSvndFULL_STOPimagemeterFULL_STOPfolderPLUS_SIGNzip = "application/vnd.imagemeter.folder+zip"
    applicationSOLIDUSvndFULL_STOPimagemeterFULL_STOPimagePLUS_SIGNzip = "application/vnd.imagemeter.image+zip"
    ...
    applicationSOLIDUSvndFULL_STOPimsFULL_STOPimsccv1p1 = "application/vnd.ims.imsccv1p1"
    applicationSOLIDUSvndFULL_STOPimsFULL_STOPimsccv1p2 = "application/vnd.ims.imsccv1p2"
    applicationSOLIDUSvndFULL_STOPimsFULL_STOPimsccv1p3 = "application/vnd.ims.imsccv1p3"
    ...
    applicationSOLIDUSvndFULL_STOPinformedcontrolFULL_STOPrmsPLUS_SIGNxml = "application/vnd.informedcontrol.rms+xml"
    applicationSOLIDUSvndFULL_STOPinformix_visionary = "application/vnd.informix-visionary"
    applicationSOLIDUSvndFULL_STOPinfotechFULL_STOPproject = "application/vnd.infotech.project"
    applicationSOLIDUSvndFULL_STOPinfotechFULL_STOPprojectPLUS_SIGNxml = "application/vnd.infotech.project+xml"
    applicationSOLIDUSvndFULL_STOPinnopathFULL_STOPwampFULL_STOPnotification = "application/vnd.innopath.wamp.notification"
    applicationSOLIDUSvndFULL_STOPinsorsFULL_STOPigm = "application/vnd.insors.igm"
    applicationSOLIDUSvndFULL_STOPinterconFULL_STOPformnet = "application/vnd.intercon.formnet"
    applicationSOLIDUSvndFULL_STOPintergeo = "application/vnd.intergeo"
    applicationSOLIDUSvndFULL_STOPintertrustFULL_STOPdigibox = "application/vnd.intertrust.digibox"
    applicationSOLIDUSvndFULL_STOPintertrustFULL_STOPnncp = "application/vnd.intertrust.nncp"
    ...
    applicationSOLIDUSvndFULL_STOPipfsFULL_STOPipns_record = "application/vnd.ipfs.ipns-record"
    applicationSOLIDUSvndFULL_STOPipldFULL_STOPcar = "application/vnd.ipld.car"
    applicationSOLIDUSvndFULL_STOPipldFULL_STOPdag_cbor = "application/vnd.ipld.dag-cbor"
    applicationSOLIDUSvndFULL_STOPipldFULL_STOPdag_json = "application/vnd.ipld.dag-json"
    applicationSOLIDUSvndFULL_STOPipldFULL_STOPraw = "application/vnd.ipld.raw"
    applicationSOLIDUSvndFULL_STOPiptcFULL_STOPg2FULL_STOPcatalogitemPLUS_SIGNxml = "application/vnd.iptc.g2.catalogitem+xml"
    applicationSOLIDUSvndFULL_STOPiptcFULL_STOPg2FULL_STOPconceptitemPLUS_SIGNxml = "application/vnd.iptc.g2.conceptitem+xml"
    applicationSOLIDUSvndFULL_STOPiptcFULL_STOPg2FULL_STOPknowledgeitemPLUS_SIGNxml = "application/vnd.iptc.g2.knowledgeitem+xml"
    applicationSOLIDUSvndFULL_STOPiptcFULL_STOPg2FULL_STOPnewsitemPLUS_SIGNxml = "application/vnd.iptc.g2.newsitem+xml"
    applicationSOLIDUSvndFULL_STOPiptcFULL_STOPg2FULL_STOPnewsmessagePLUS_SIGNxml = "application/vnd.iptc.g2.newsmessage+xml"
    applicationSOLIDUSvndFULL_STOPiptcFULL_STOPg2FULL_STOPpackageitemPLUS_SIGNxml = "application/vnd.iptc.g2.packageitem+xml"
    applicationSOLIDUSvndFULL_STOPiptcFULL_STOPg2FULL_STOPplanningitemPLUS_SIGNxml = "application/vnd.iptc.g2.planningitem+xml"
    applicationSOLIDUSvndFULL_STOPipunpluggedFULL_STOPrcprofile = "application/vnd.ipunplugged.rcprofile"
    applicationSOLIDUSvndFULL_STOPirepositoryFULL_STOPpackagePLUS_SIGNxml = "application/vnd.irepository.package+xml"
    applicationSOLIDUSvndFULL_STOPisacFULL_STOPfcs = "application/vnd.isac.fcs"
    applicationSOLIDUSvndFULL_STOPiso11783_10PLUS_SIGNzip = "application/vnd.iso11783-10+zip"
    applicationSOLIDUSvndFULL_STOPis_xpr = "application/vnd.is-xpr"
    applicationSOLIDUSvndFULL_STOPjam = "application/vnd.jam"
    applicationSOLIDUSvndFULL_STOPjapannet_directory_service = "application/vnd.japannet-directory-service"
    applicationSOLIDUSvndFULL_STOPjapannet_jpnstore_wakeup = "application/vnd.japannet-jpnstore-wakeup"
    applicationSOLIDUSvndFULL_STOPjapannet_payment_wakeup = "application/vnd.japannet-payment-wakeup"
    applicationSOLIDUSvndFULL_STOPjapannet_registration = "application/vnd.japannet-registration"
    applicationSOLIDUSvndFULL_STOPjapannet_registration_wakeup = "application/vnd.japannet-registration-wakeup"
    applicationSOLIDUSvndFULL_STOPjapannet_setstore_wakeup = "application/vnd.japannet-setstore-wakeup"
    applicationSOLIDUSvndFULL_STOPjapannet_verification = "application/vnd.japannet-verification"
    applicationSOLIDUSvndFULL_STOPjapannet_verification_wakeup = "application/vnd.japannet-verification-wakeup"
    applicationSOLIDUSvndFULL_STOPjcpFULL_STOPjavameFULL_STOPmidlet_rms = "application/vnd.jcp.javame.midlet-rms"
    applicationSOLIDUSvndFULL_STOPjisp = "application/vnd.jisp"
    applicationSOLIDUSvndFULL_STOPjoostFULL_STOPjoda_archive = "application/vnd.joost.joda-archive"
    ...
    applicationSOLIDUSvndFULL_STOPkdeFULL_STOPkpresenter = "application/vnd.kde.kpresenter"
    ...
    applicationSOLIDUSvndFULL_STOPkeymanFULL_STOPkmpPLUS_SIGNzip = "application/vnd.keyman.kmp+zip"
    ...
    applicationSOLIDUSvndFULL_STOPlasFULL_STOPlasPLUS_SIGNjson = "application/vnd.las.las+json"
    applicationSOLIDUSvndFULL_STOPlasFULL_STOPlasPLUS_SIGNxml = "application/vnd.las.las+xml"
    applicationSOLIDUSvndFULL_STOPlaszip = "application/vnd.laszip"
    applicationSOLIDUSvndFULL_STOPldevFULL_STOPproductlicensing = "application/vnd.ldev.productlicensing"
    applicationSOLIDUSvndFULL_STOPleapPLUS_SIGNjson = "application/vnd.leap+json"
    applicationSOLIDUSvndFULL_STOPliberty_requestPLUS_SIGNxml = "application/vnd.liberty-request+xml"
    applicationSOLIDUSvndFULL_STOPllamagraphicsFULL_STOPlife_balanceFULL_STOPdesktop = "application/vnd.llamagraphics.life-balance.desktop"
    ...
    applicationSOLIDUSvndFULL_STOPlogipipeFULL_STOPcircuitPLUS_SIGNzip = "application/vnd.logipipe.circuit+zip"
    ...
    applicationSOLIDUSvndFULL_STOPmacportsFULL_STOPportpkg = "application/vnd.macports.portpkg"
    applicationSOLIDUSvndFULL_STOPmapbox_vector_tile = "application/vnd.mapbox-vector-tile"
    applicationSOLIDUSvndFULL_STOPmarlinFULL_STOPdrmFULL_STOPactiontokenPLUS_SIGNxml = "application/vnd.marlin.drm.actiontoken+xml"
    applicationSOLIDUSvndFULL_STOPmarlinFULL_STOPdrmFULL_STOPconftokenPLUS_SIGNxml = "application/vnd.marlin.drm.conftoken+xml"
    applicationSOLIDUSvndFULL_STOPmarlinFULL_STOPdrmFULL_STOPlicensePLUS_SIGNxml = "application/vnd.marlin.drm.license+xml"
    applicationSOLIDUSvndFULL_STOPmarlinFULL_STOPdrmFULL_STOPmdcf = "application/vnd.marlin.drm.mdcf"
    applicationSOLIDUSvndFULL_STOPmasonPLUS_SIGNjson = "application/vnd.mason+json"
    applicationSOLIDUSvndFULL_STOPmaxarFULL_STOParchiveFULL_STOP3tzPLUS_SIGNzip = "application/vnd.maxar.archive.3tz+zip"
    applicationSOLIDUSvndFULL_STOPmaxmindFULL_STOPmaxmind_db = "application/vnd.maxmind.maxmind-db"
    ...
    applicationSOLIDUSvndFULL_STOPmediastationFULL_STOPcdkey = "application/vnd.mediastation.cdkey"
    applicationSOLIDUSvndFULL_STOPmedicalholodeckFULL_STOPrecordxr = "application/vnd.medicalholodeck.recordxr"
    applicationSOLIDUSvndFULL_STOPmeridian_slingshot = "application/vnd.meridian-slingshot"
    ...
    applicationSOLIDUSvndFULL_STOPmicrografxFULL_STOPflo = "application/vnd.micrografx.flo"
    applicationSOLIDUSvndFULL_STOPmicrografxFULL_STOPigx = "application/vnd.micrografx.igx"
    applicationSOLIDUSvndFULL_STOPmicrosoftFULL_STOPportable_executable = "application/vnd.microsoft.portable-executable"
    applicationSOLIDUSvndFULL_STOPmicrosoftFULL_STOPwindowsFULL_STOPthumbnail_cache = "application/vnd.microsoft.windows.thumbnail-cache"
    ...
    applicationSOLIDUSvndFULL_STOPminisoft_hp3000_save = "application/vnd.minisoft-hp3000-save"
    applicationSOLIDUSvndFULL_STOPmitsubishiFULL_STOPmisty_guardFULL_STOPtrustweb = "application/vnd.mitsubishi.misty-guard.trustweb"
    ...
    applicationSOLIDUSvndFULL_STOPmophunFULL_STOPapplication = "application/vnd.mophun.application"
    applicationSOLIDUSvndFULL_STOPmophunFULL_STOPcertificate = "application/vnd.mophun.certificate"
    applicationSOLIDUSvndFULL_STOPmotorolaFULL_STOPflexsuite = "application/vnd.motorola.flexsuite"
    applicationSOLIDUSvndFULL_STOPmotorolaFULL_STOPflexsuiteFULL_STOPadsi = "application/vnd.motorola.flexsuite.adsi"
    applicationSOLIDUSvndFULL_STOPmotorolaFULL_STOPflexsuiteFULL_STOPfis = "application/vnd.motorola.flexsuite.fis"
    applicationSOLIDUSvndFULL_STOPmotorolaFULL_STOPflexsuiteFULL_STOPgotap = "application/vnd.motorola.flexsuite.gotap"
    applicationSOLIDUSvndFULL_STOPmotorolaFULL_STOPflexsuiteFULL_STOPkmr = "application/vnd.motorola.flexsuite.kmr"
    applicationSOLIDUSvndFULL_STOPmotorolaFULL_STOPflexsuiteFULL_STOPttc = "application/vnd.motorola.flexsuite.ttc"
    applicationSOLIDUSvndFULL_STOPmotorolaFULL_STOPflexsuiteFULL_STOPwem = "application/vnd.motorola.flexsuite.wem"
    applicationSOLIDUSvndFULL_STOPmotorolaFULL_STOPiprm = "application/vnd.motorola.iprm"
    applicationSOLIDUSvndFULL_STOPmozillaFULL_STOPxulPLUS_SIGNxml = "application/vnd.mozilla.xul+xml"
    ...
    applicationSOLIDUSvndFULL_STOPms_cab_compressed = "application/vnd.ms-cab-compressed"
    ...
    applicationSOLIDUSvndFULL_STOPms_officeFULL_STOPactiveXPLUS_SIGNxml = "application/vnd.ms-office.activeX+xml"
    applicationSOLIDUSvndFULL_STOPms_officetheme = "application/vnd.ms-officetheme"
    applicationSOLIDUSvndFULL_STOPms_playreadyFULL_STOPinitiatorPLUS_SIGNxml = "application/vnd.ms-playready.initiator+xml"
    ...
    applicationSOLIDUSvndFULL_STOPms_PrintDeviceCapabilitiesPLUS_SIGNxml = "application/vnd.ms-PrintDeviceCapabilities+xml"
    applicationSOLIDUSvndFULL_STOPms_PrintSchemaTicketPLUS_SIGNxml = "application/vnd.ms-PrintSchemaTicket+xml"
    ...
    applicationSOLIDUSvndFULL_STOPms_windowsFULL_STOPdevicepairing = "application/vnd.ms-windows.devicepairing"
    applicationSOLIDUSvndFULL_STOPms_windowsFULL_STOPnwprintingFULL_STOPoob = "application/vnd.ms-windows.nwprinting.oob"
    applicationSOLIDUSvndFULL_STOPms_windowsFULL_STOPprinterpairing = "application/vnd.ms-windows.printerpairing"
    applicationSOLIDUSvndFULL_STOPms_windowsFULL_STOPwsdFULL_STOPoob = "application/vnd.ms-windows.wsd.oob"
    applicationSOLIDUSvndFULL_STOPms_wmdrmFULL_STOPlic_chlg_req = "application/vnd.ms-wmdrm.lic-chlg-req"
    applicationSOLIDUSvndFULL_STOPms_wmdrmFULL_STOPlic_resp = "application/vnd.ms-wmdrm.lic-resp"
    applicationSOLIDUSvndFULL_STOPms_wmdrmFULL_STOPmeter_chlg_req = "application/vnd.ms-wmdrm.meter-chlg-req"
    applicationSOLIDUSvndFULL_STOPms_wmdrmFULL_STOPmeter_resp = "application/vnd.ms-wmdrm.meter-resp"
    ...
    applicationSOLIDUSvndFULL_STOPmultiadFULL_STOPcreator = "application/vnd.multiad.creator"
    applicationSOLIDUSvndFULL_STOPmultiadFULL_STOPcreatorFULL_STOPcif = "application/vnd.multiad.creator.cif"
    ...
    applicationSOLIDUSvndFULL_STOPnacamarFULL_STOPybridPLUS_SIGNjson = "application/vnd.nacamar.ybrid+json"
    applicationSOLIDUSvndFULL_STOPnatoFULL_STOPbindingdataobjectPLUS_SIGNcbor = "application/vnd.nato.bindingdataobject+cbor"
    applicationSOLIDUSvndFULL_STOPnatoFULL_STOPbindingdataobjectPLUS_SIGNjson = "application/vnd.nato.bindingdataobject+json"
    applicationSOLIDUSvndFULL_STOPnatoFULL_STOPbindingdataobjectPLUS_SIGNxml = "application/vnd.nato.bindingdataobject+xml"
    ...
    applicationSOLIDUSvndFULL_STOPncdFULL_STOPreference = "application/vnd.ncd.reference"
    applicationSOLIDUSvndFULL_STOPnearstFULL_STOPinvPLUS_SIGNjson = "application/vnd.nearst.inv+json"
    applicationSOLIDUSvndFULL_STOPnebumindFULL_STOPline = "application/vnd.nebumind.line"
    applicationSOLIDUSvndFULL_STOPnervana = "application/vnd.nervana"
    applicationSOLIDUSvndFULL_STOPnetfpx = "application/vnd.netfpx"
    applicationSOLIDUSvndFULL_STOPneurolanguageFULL_STOPnlu = "application/vnd.neurolanguage.nlu"
    applicationSOLIDUSvndFULL_STOPnimn = "application/vnd.nimn"
    applicationSOLIDUSvndFULL_STOPnintendoFULL_STOPnitroFULL_STOProm = "application/vnd.nintendo.nitro.rom"
    applicationSOLIDUSvndFULL_STOPnintendoFULL_STOPsnesFULL_STOProm = "application/vnd.nintendo.snes.rom"
    applicationSOLIDUSvndFULL_STOPnitf = "application/vnd.nitf"
    applicationSOLIDUSvndFULL_STOPnoblenet_directory = "application/vnd.noblenet-directory"
    ...
    applicationSOLIDUSvndFULL_STOPnokiaFULL_STOPcatalogs = "application/vnd.nokia.catalogs"
    applicationSOLIDUSvndFULL_STOPnokiaFULL_STOPconmlPLUS_SIGNwbxml = "application/vnd.nokia.conml+wbxml"
    applicationSOLIDUSvndFULL_STOPnokiaFULL_STOPconmlPLUS_SIGNxml = "application/vnd.nokia.conml+xml"
    applicationSOLIDUSvndFULL_STOPnokiaFULL_STOPiptvFULL_STOPconfigPLUS_SIGNxml = "application/vnd.nokia.iptv.config+xml"
    applicationSOLIDUSvndFULL_STOPnokiaFULL_STOPiSDS_radio_presets = "application/vnd.nokia.iSDS-radio-presets"
    applicationSOLIDUSvndFULL_STOPnokiaFULL_STOPlandmarkPLUS_SIGNwbxml = "application/vnd.nokia.landmark+wbxml"
    applicationSOLIDUSvndFULL_STOPnokiaFULL_STOPlandmarkPLUS_SIGNxml = "application/vnd.nokia.landmark+xml"
    applicationSOLIDUSvndFULL_STOPnokiaFULL_STOPlandmarkcollectionPLUS_SIGNxml = "application/vnd.nokia.landmarkcollection+xml"
    applicationSOLIDUSvndFULL_STOPnokiaFULL_STOPncd = "application/vnd.nokia.ncd"
    applicationSOLIDUSvndFULL_STOPnokiaFULL_STOPn_gageFULL_STOPacPLUS_SIGNxml = "application/vnd.nokia.n-gage.ac+xml"
    applicationSOLIDUSvndFULL_STOPnokiaFULL_STOPn_gageFULL_STOPdata = "application/vnd.nokia.n-gage.data"
    ...
    applicationSOLIDUSvndFULL_STOPnokiaFULL_STOPpcdPLUS_SIGNwbxml = "application/vnd.nokia.pcd+wbxml"
    applicationSOLIDUSvndFULL_STOPnokiaFULL_STOPpcdPLUS_SIGNxml = "application/vnd.nokia.pcd+xml"
    applicationSOLIDUSvndFULL_STOPnokiaFULL_STOPradio_preset = "application/vnd.nokia.radio-preset"
    applicationSOLIDUSvndFULL_STOPnokiaFULL_STOPradio_presets = "application/vnd.nokia.radio-presets"
    ...
    applicationSOLIDUSvndFULL_STOPntt_localFULL_STOPcontent_share = "application/vnd.ntt-local.content-share"
    applicationSOLIDUSvndFULL_STOPntt_localFULL_STOPfile_transfer = "application/vnd.ntt-local.file-transfer"
    applicationSOLIDUSvndFULL_STOPntt_localFULL_STOPogw_remote_access = "application/vnd.ntt-local.ogw_remote-access"
    applicationSOLIDUSvndFULL_STOPntt_localFULL_STOPsip_ta_remote = "application/vnd.ntt-local.sip-ta_remote"
    applicationSOLIDUSvndFULL_STOPntt_localFULL_STOPsip_ta_tcp_stream = "application/vnd.ntt-local.sip-ta_tcp_stream"
    applicationSOLIDUSvndFULL_STOPoaiFULL_STOPworkflows = "application/vnd.oai.workflows"
    applicationSOLIDUSvndFULL_STOPoaiFULL_STOPworkflowsPLUS_SIGNjson = "application/vnd.oai.workflows+json"
    applicationSOLIDUSvndFULL_STOPoaiFULL_STOPworkflowsPLUS_SIGNyaml = "application/vnd.oai.workflows+yaml"
    applicationSOLIDUSvndFULL_STOPoasisFULL_STOPopendocumentFULL_STOPbase = "application/vnd.oasis.opendocument.base"
    applicationSOLIDUSvndFULL_STOPoasisFULL_STOPopendocumentFULL_STOPchart = "application/vnd.oasis.opendocument.chart"
    applicationSOLIDUSvndFULL_STOPoasisFULL_STOPopendocumentFULL_STOPchart_template = "application/vnd.oasis.opendocument.chart-template"
    applicationSOLIDUSvndFULL_STOPoasisFULL_STOPopendocumentFULL_STOPdatabase = "application/vnd.oasis.opendocument.database"
    applicationSOLIDUSvndFULL_STOPoasisFULL_STOPopendocumentFULL_STOPformula = "application/vnd.oasis.opendocument.formula"
    ...
    applicationSOLIDUSvndFULL_STOPoasisFULL_STOPopendocumentFULL_STOPgraphics = "application/vnd.oasis.opendocument.graphics"
    ...
    applicationSOLIDUSvndFULL_STOPoasisFULL_STOPopendocumentFULL_STOPimage = "application/vnd.oasis.opendocument.image"
    applicationSOLIDUSvndFULL_STOPoasisFULL_STOPopendocumentFULL_STOPimage_template = "application/vnd.oasis.opendocument.image-template"
    applicationSOLIDUSvndFULL_STOPoasisFULL_STOPopendocumentFULL_STOPpresentation = "application/vnd.oasis.opendocument.presentation"
    ...
    applicationSOLIDUSvndFULL_STOPoasisFULL_STOPopendocumentFULL_STOPspreadsheet = "application/vnd.oasis.opendocument.spreadsheet"
    ...
    applicationSOLIDUSvndFULL_STOPoasisFULL_STOPopendocumentFULL_STOPtext = "application/vnd.oasis.opendocument.text"
    applicationSOLIDUSvndFULL_STOPoasisFULL_STOPopendocumentFULL_STOPtext_master = "application/vnd.oasis.opendocument.text-master"
    ...
    applicationSOLIDUSvndFULL_STOPoasisFULL_STOPopendocumentFULL_STOPtext_template = "application/vnd.oasis.opendocument.text-template"
    applicationSOLIDUSvndFULL_STOPoasisFULL_STOPopendocumentFULL_STOPtext_web = "application/vnd.oasis.opendocument.text-web"
    ...
    applicationSOLIDUSvndFULL_STOPoftnFULL_STOPl10nPLUS_SIGNjson = "application/vnd.oftn.l10n+json"
    applicationSOLIDUSvndFULL_STOPoipfFULL_STOPcontentaccessdownloadPLUS_SIGNxml = "application/vnd.oipf.contentaccessdownload+xml"
    applicationSOLIDUSvndFULL_STOPoipfFULL_STOPcontentaccessstreamingPLUS_SIGNxml = "application/vnd.oipf.contentaccessstreaming+xml"
    applicationSOLIDUSvndFULL_STOPoipfFULL_STOPcspg_hexbinary = "application/vnd.oipf.cspg-hexbinary"
    applicationSOLIDUSvndFULL_STOPoipfFULL_STOPdaeFULL_STOPsvgPLUS_SIGNxml = "application/vnd.oipf.dae.svg+xml"
    applicationSOLIDUSvndFULL_STOPoipfFULL_STOPdaeFULL_STOPxhtmlPLUS_SIGNxml = "application/vnd.oipf.dae.xhtml+xml"
    applicationSOLIDUSvndFULL_STOPoipfFULL_STOPmippvcontrolmessagePLUS_SIGNxml = "application/vnd.oipf.mippvcontrolmessage+xml"
    applicationSOLIDUSvndFULL_STOPoipfFULL_STOPpaeFULL_STOPgem = "application/vnd.oipf.pae.gem"
    applicationSOLIDUSvndFULL_STOPoipfFULL_STOPspdiscoveryPLUS_SIGNxml = "application/vnd.oipf.spdiscovery+xml"
    applicationSOLIDUSvndFULL_STOPoipfFULL_STOPspdlistPLUS_SIGNxml = "application/vnd.oipf.spdlist+xml"
    applicationSOLIDUSvndFULL_STOPoipfFULL_STOPueprofilePLUS_SIGNxml = "application/vnd.oipf.ueprofile+xml"
    applicationSOLIDUSvndFULL_STOPoipfFULL_STOPuserprofilePLUS_SIGNxml = "application/vnd.oipf.userprofile+xml"
    ...
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPbcastFULL_STOPdrm_triggerPLUS_SIGNxml = "application/vnd.oma.bcast.drm-trigger+xml"
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPbcastFULL_STOPimdPLUS_SIGNxml = "application/vnd.oma.bcast.imd+xml"
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPbcastFULL_STOPltkm = "application/vnd.oma.bcast.ltkm"
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPbcastFULL_STOPnotificationPLUS_SIGNxml = "application/vnd.oma.bcast.notification+xml"
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPbcastFULL_STOPprovisioningtrigger = "application/vnd.oma.bcast.provisioningtrigger"
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPbcastFULL_STOPsgboot = "application/vnd.oma.bcast.sgboot"
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPbcastFULL_STOPsgddPLUS_SIGNxml = "application/vnd.oma.bcast.sgdd+xml"
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPbcastFULL_STOPsgdu = "application/vnd.oma.bcast.sgdu"
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPbcastFULL_STOPsimple_symbol_container = "application/vnd.oma.bcast.simple-symbol-container"
    ...
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPbcastFULL_STOPsprovPLUS_SIGNxml = "application/vnd.oma.bcast.sprov+xml"
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPbcastFULL_STOPstkm = "application/vnd.oma.bcast.stkm"
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPcab_address_bookPLUS_SIGNxml = "application/vnd.oma.cab-address-book+xml"
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPcab_feature_handlerPLUS_SIGNxml = "application/vnd.oma.cab-feature-handler+xml"
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPcab_pccPLUS_SIGNxml = "application/vnd.oma.cab-pcc+xml"
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPcab_subs_invitePLUS_SIGNxml = "application/vnd.oma.cab-subs-invite+xml"
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPcab_user_prefsPLUS_SIGNxml = "application/vnd.oma.cab-user-prefs+xml"
    ...
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPdd2PLUS_SIGNxml = "application/vnd.oma.dd2+xml"
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPdrmFULL_STOPrisdPLUS_SIGNxml = "application/vnd.oma.drm.risd+xml"
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPgroup_usage_listPLUS_SIGNxml = "application/vnd.oma.group-usage-list+xml"
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPlwm2mPLUS_SIGNcbor = "application/vnd.oma.lwm2m+cbor"
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPlwm2mPLUS_SIGNjson = "application/vnd.oma.lwm2m+json"
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPlwm2mPLUS_SIGNtlv = "application/vnd.oma.lwm2m+tlv"
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPpalPLUS_SIGNxml = "application/vnd.oma.pal+xml"
    ...
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPpocFULL_STOPfinal_reportPLUS_SIGNxml = "application/vnd.oma.poc.final-report+xml"
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPpocFULL_STOPgroupsPLUS_SIGNxml = "application/vnd.oma.poc.groups+xml"
    ...
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPscidmFULL_STOPmessagesPLUS_SIGNxml = "application/vnd.oma.scidm.messages+xml"
    applicationSOLIDUSvndFULL_STOPomaFULL_STOPxcap_directoryPLUS_SIGNxml = "application/vnd.oma.xcap-directory+xml"
    applicationSOLIDUSvndFULL_STOPomads_emailPLUS_SIGNxml = "application/vnd.omads-email+xml"
    applicationSOLIDUSvndFULL_STOPomads_filePLUS_SIGNxml = "application/vnd.omads-file+xml"
    applicationSOLIDUSvndFULL_STOPomads_folderPLUS_SIGNxml = "application/vnd.omads-folder+xml"
    ...
    applicationSOLIDUSvndFULL_STOPoma_scws_http_request = "application/vnd.oma-scws-http-request"
    applicationSOLIDUSvndFULL_STOPoma_scws_http_response = "application/vnd.oma-scws-http-response"
    ...
    applicationSOLIDUSvndFULL_STOPonvifFULL_STOPmetadata = "application/vnd.onvif.metadata"
    applicationSOLIDUSvndFULL_STOPopenbloxFULL_STOPgamePLUS_SIGNxml = "application/vnd.openblox.game+xml"
    applicationSOLIDUSvndFULL_STOPopenbloxFULL_STOPgame_binary = "application/vnd.openblox.game-binary"
    applicationSOLIDUSvndFULL_STOPopeneyeFULL_STOPoeb = "application/vnd.openeye.oeb"
    applicationSOLIDUSvndFULL_STOPopenstreetmapFULL_STOPdataPLUS_SIGNxml = "application/vnd.openstreetmap.data+xml"
    applicationSOLIDUSvndFULL_STOPopentimestampsFULL_STOPots = "application/vnd.opentimestamps.ots"
    applicationSOLIDUSvndFULL_STOPopenvpiFULL_STOPdspxPLUS_SIGNjson = "application/vnd.openvpi.dspx+json"
    ...
    applicationSOLIDUSvndFULL_STOPopenxmlformats_officedocumentFULL_STOPvmlDrawing = "application/vnd.openxmlformats-officedocument.vmlDrawing"
    ...
    applicationSOLIDUSvndFULL_STOPoracleFULL_STOPresourcePLUS_SIGNjson = "application/vnd.oracle.resource+json"
    applicationSOLIDUSvndFULL_STOPorangeFULL_STOPindata = "application/vnd.orange.indata"
    applicationSOLIDUSvndFULL_STOPosaFULL_STOPnetdeploy = "application/vnd.osa.netdeploy"
    applicationSOLIDUSvndFULL_STOPosgeoFULL_STOPmapguideFULL_STOPpackage = "application/vnd.osgeo.mapguide.package"
    ...
    applicationSOLIDUSvndFULL_STOPosgiFULL_STOPsubsystem = "application/vnd.osgi.subsystem"
    applicationSOLIDUSvndFULL_STOPotpsFULL_STOPct_kipPLUS_SIGNxml = "application/vnd.otps.ct-kip+xml"
    applicationSOLIDUSvndFULL_STOPoxliFULL_STOPcountgraph = "application/vnd.oxli.countgraph"
    applicationSOLIDUSvndFULL_STOPpagerdutyPLUS_SIGNjson = "application/vnd.pagerduty+json"
    ...
    applicationSOLIDUSvndFULL_STOPpiaccessFULL_STOPapplication_licence = "application/vnd.piaccess.application-licence"
    ...
    applicationSOLIDUSvndFULL_STOPpocFULL_STOPgroup_advertisementPLUS_SIGNxml = "application/vnd.poc.group-advertisement+xml"
    ...
    applicationSOLIDUSvndFULL_STOPpreviewsystemsFULL_STOPbox = "application/vnd.previewsystems.box"
    applicationSOLIDUSvndFULL_STOPproteusFULL_STOPmagazine = "application/vnd.proteus.magazine"
    applicationSOLIDUSvndFULL_STOPpsfs = "application/vnd.psfs"
    applicationSOLIDUSvndFULL_STOPptFULL_STOPmundusmundi = "application/vnd.pt.mundusmundi"
    applicationSOLIDUSvndFULL_STOPpublishare_delta_tree = "application/vnd.publishare-delta-tree"
    ...
    applicationSOLIDUSvndFULL_STOPpwg_xhtml_printPLUS_SIGNxml = "application/vnd.pwg-xhtml-print+xml"
    applicationSOLIDUSvndFULL_STOPqualcommFULL_STOPbrew_app_res = "application/vnd.qualcomm.brew-app-res"
    applicationSOLIDUSvndFULL_STOPquarantainenet = "application/vnd.quarantainenet"
    applicationSOLIDUSvndFULL_STOPQuarkFULL_STOPQuarkXPress = "application/vnd.Quark.QuarkXPress"
    applicationSOLIDUSvndFULL_STOPquobject_quoxdocument = "application/vnd.quobject-quoxdocument"
    applicationSOLIDUSvndFULL_STOPradisysFULL_STOPmomlPLUS_SIGNxml = "application/vnd.radisys.moml+xml"
    applicationSOLIDUSvndFULL_STOPradisysFULL_STOPmsmlPLUS_SIGNxml = "application/vnd.radisys.msml+xml"
    applicationSOLIDUSvndFULL_STOPradisysFULL_STOPmsml_auditPLUS_SIGNxml = "application/vnd.radisys.msml-audit+xml"
    applicationSOLIDUSvndFULL_STOPradisysFULL_STOPmsml_audit_confPLUS_SIGNxml = "application/vnd.radisys.msml-audit-conf+xml"
    applicationSOLIDUSvndFULL_STOPradisysFULL_STOPmsml_audit_connPLUS_SIGNxml = "application/vnd.radisys.msml-audit-conn+xml"
    applicationSOLIDUSvndFULL_STOPradisysFULL_STOPmsml_audit_dialogPLUS_SIGNxml = "application/vnd.radisys.msml-audit-dialog+xml"
    applicationSOLIDUSvndFULL_STOPradisysFULL_STOPmsml_audit_streamPLUS_SIGNxml = "application/vnd.radisys.msml-audit-stream+xml"
    applicationSOLIDUSvndFULL_STOPradisysFULL_STOPmsml_confPLUS_SIGNxml = "application/vnd.radisys.msml-conf+xml"
    applicationSOLIDUSvndFULL_STOPradisysFULL_STOPmsml_dialogPLUS_SIGNxml = "application/vnd.radisys.msml-dialog+xml"
    applicationSOLIDUSvndFULL_STOPradisysFULL_STOPmsml_dialog_basePLUS_SIGNxml = "application/vnd.radisys.msml-dialog-base+xml"
    applicationSOLIDUSvndFULL_STOPradisysFULL_STOPmsml_dialog_fax_detectPLUS_SIGNxml = "application/vnd.radisys.msml-dialog-fax-detect+xml"
    ...
    applicationSOLIDUSvndFULL_STOPradisysFULL_STOPmsml_dialog_groupPLUS_SIGNxml = "application/vnd.radisys.msml-dialog-group+xml"
    applicationSOLIDUSvndFULL_STOPradisysFULL_STOPmsml_dialog_speechPLUS_SIGNxml = "application/vnd.radisys.msml-dialog-speech+xml"
    applicationSOLIDUSvndFULL_STOPradisysFULL_STOPmsml_dialog_transformPLUS_SIGNxml = "application/vnd.radisys.msml-dialog-transform+xml"
    applicationSOLIDUSvndFULL_STOPrainstorFULL_STOPdata = "application/vnd.rainstor.data"
    ...
    applicationSOLIDUSvndFULL_STOPrecordareFULL_STOPmusicxml = "application/vnd.recordare.musicxml"
    applicationSOLIDUSvndFULL_STOPrecordareFULL_STOPmusicxmlPLUS_SIGNxml = "application/vnd.recordare.musicxml+xml"
    applicationSOLIDUSvndFULL_STOPrelpipe = "application/vnd.relpipe"
    applicationSOLIDUSvndFULL_STOPRenLearnFULL_STOPrlprint = "application/vnd.RenLearn.rlprint"
    applicationSOLIDUSvndFULL_STOPresilientFULL_STOPlogic = "application/vnd.resilient.logic"
    applicationSOLIDUSvndFULL_STOPrestfulPLUS_SIGNjson = "application/vnd.restful+json"
    applicationSOLIDUSvndFULL_STOPrigFULL_STOPcryptonote = "application/vnd.rig.cryptonote"
    applicationSOLIDUSvndFULL_STOProute66FULL_STOPlink66PLUS_SIGNxml = "application/vnd.route66.link66+xml"
    applicationSOLIDUSvndFULL_STOPrs_274x = "application/vnd.rs-274x"
    applicationSOLIDUSvndFULL_STOPruckusFULL_STOPdownload = "application/vnd.ruckus.download"
    applicationSOLIDUSvndFULL_STOPs3sms = "application/vnd.s3sms"
    applicationSOLIDUSvndFULL_STOPsailingtrackerFULL_STOPtrack = "application/vnd.sailingtracker.track"
    ...
    applicationSOLIDUSvndFULL_STOPsealedmediaFULL_STOPsoftsealFULL_STOPhtml = "application/vnd.sealedmedia.softseal.html"
    applicationSOLIDUSvndFULL_STOPsealedmediaFULL_STOPsoftsealFULL_STOPpdf = "application/vnd.sealedmedia.softseal.pdf"
    ...
    applicationSOLIDUSvndFULL_STOPshanaFULL_STOPinformedFULL_STOPformdata = "application/vnd.shana.informed.formdata"
    applicationSOLIDUSvndFULL_STOPshanaFULL_STOPinformedFULL_STOPformtemplate = "application/vnd.shana.informed.formtemplate"
    applicationSOLIDUSvndFULL_STOPshanaFULL_STOPinformedFULL_STOPinterchange = "application/vnd.shana.informed.interchange"
    applicationSOLIDUSvndFULL_STOPshanaFULL_STOPinformedFULL_STOPpackage = "application/vnd.shana.informed.package"
    applicationSOLIDUSvndFULL_STOPshootproofPLUS_SIGNjson = "application/vnd.shootproof+json"
    applicationSOLIDUSvndFULL_STOPshopkickPLUS_SIGNjson = "application/vnd.shopkick+json"
    applicationSOLIDUSvndFULL_STOPshp = "application/vnd.shp"
    applicationSOLIDUSvndFULL_STOPshx = "application/vnd.shx"
    applicationSOLIDUSvndFULL_STOPsigrokFULL_STOPsession = "application/vnd.sigrok.session"
    applicationSOLIDUSvndFULL_STOPSimTech_MindMapper = "application/vnd.SimTech-MindMapper"
    ...
    applicationSOLIDUSvndFULL_STOPsmartFULL_STOPnotebook = "application/vnd.smart.notebook"
    applicationSOLIDUSvndFULL_STOPsmartFULL_STOPteacher = "application/vnd.smart.teacher"
    applicationSOLIDUSvndFULL_STOPsmintioFULL_STOPportalsFULL_STOParchive = "application/vnd.smintio.portals.archive"
    applicationSOLIDUSvndFULL_STOPsnesdev_page_table = "application/vnd.snesdev-page-table"
    ...
    applicationSOLIDUSvndFULL_STOPsoftware602FULL_STOPfillerFULL_STOPform_xml_zip = "application/vnd.software602.filler.form-xml-zip"
    applicationSOLIDUSvndFULL_STOPsolentFULL_STOPsdkmPLUS_SIGNxml = "application/vnd.solent.sdkm+xml"
    ...
    applicationSOLIDUSvndFULL_STOPstepmaniaFULL_STOPpackage = "application/vnd.stepmania.package"
    applicationSOLIDUSvndFULL_STOPstepmaniaFULL_STOPstepchart = "application/vnd.stepmania.stepchart"
    applicationSOLIDUSvndFULL_STOPstreet_stream = "application/vnd.street-stream"
    applicationSOLIDUSvndFULL_STOPsunFULL_STOPwadlPLUS_SIGNxml = "application/vnd.sun.wadl+xml"
    ...
    applicationSOLIDUSvndFULL_STOPsyncmlFULL_STOPdmFULL_STOPnotification = "application/vnd.syncml.dm.notification"
    applicationSOLIDUSvndFULL_STOPsyncmlFULL_STOPdmPLUS_SIGNwbxml = "application/vnd.syncml.dm+wbxml"
    applicationSOLIDUSvndFULL_STOPsyncmlFULL_STOPdmPLUS_SIGNxml = "application/vnd.syncml.dm+xml"
    applicationSOLIDUSvndFULL_STOPsyncmlFULL_STOPdmddfPLUS_SIGNwbxml = "application/vnd.syncml.dmddf+wbxml"
    applicationSOLIDUSvndFULL_STOPsyncmlFULL_STOPdmddfPLUS_SIGNxml = "application/vnd.syncml.dmddf+xml"
    applicationSOLIDUSvndFULL_STOPsyncmlFULL_STOPdmtndsPLUS_SIGNwbxml = "application/vnd.syncml.dmtnds+wbxml"
    applicationSOLIDUSvndFULL_STOPsyncmlFULL_STOPdmtndsPLUS_SIGNxml = "application/vnd.syncml.dmtnds+xml"
    applicationSOLIDUSvndFULL_STOPsyncmlFULL_STOPdsFULL_STOPnotification = "application/vnd.syncml.ds.notification"
    applicationSOLIDUSvndFULL_STOPsyncmlPLUS_SIGNxml = "application/vnd.syncml+xml"
    applicationSOLIDUSvndFULL_STOPtableschemaPLUS_SIGNjson = "application/vnd.tableschema+json"
    applicationSOLIDUSvndFULL_STOPtaoFULL_STOPintent_module_archive = "application/vnd.tao.intent-module-archive"
    applicationSOLIDUSvndFULL_STOPtcpdumpFULL_STOPpcap = "application/vnd.tcpdump.pcap"
    applicationSOLIDUSvndFULL_STOPthink_cellFULL_STOPppttcPLUS_SIGNjson = "application/vnd.think-cell.ppttc+json"
    applicationSOLIDUSvndFULL_STOPtmdFULL_STOPmediaflexFULL_STOPapiPLUS_SIGNxml = "application/vnd.tmd.mediaflex.api+xml"
    ...
    applicationSOLIDUSvndFULL_STOPtriFULL_STOPonesource = "application/vnd.tri.onesource"
    ...
    applicationSOLIDUSvndFULL_STOPubisoftFULL_STOPwebplayer = "application/vnd.ubisoft.webplayer"
    applicationSOLIDUSvndFULL_STOPufdl = "application/vnd.ufdl"
    applicationSOLIDUSvndFULL_STOPuicFULL_STOPosdmPLUS_SIGNjson = "application/vnd.uic.osdm+json"
    ...
    applicationSOLIDUSvndFULL_STOPuplanetFULL_STOPalert = "application/vnd.uplanet.alert"
    applicationSOLIDUSvndFULL_STOPuplanetFULL_STOPalert_wbxml = "application/vnd.uplanet.alert-wbxml"
    applicationSOLIDUSvndFULL_STOPuplanetFULL_STOPbearer_choice = "application/vnd.uplanet.bearer-choice"
    applicationSOLIDUSvndFULL_STOPuplanetFULL_STOPbearer_choice_wbxml = "application/vnd.uplanet.bearer-choice-wbxml"
    applicationSOLIDUSvndFULL_STOPuplanetFULL_STOPcacheop = "application/vnd.uplanet.cacheop"
    applicationSOLIDUSvndFULL_STOPuplanetFULL_STOPcacheop_wbxml = "application/vnd.uplanet.cacheop-wbxml"
    applicationSOLIDUSvndFULL_STOPuplanetFULL_STOPchannel = "application/vnd.uplanet.channel"
    applicationSOLIDUSvndFULL_STOPuplanetFULL_STOPchannel_wbxml = "application/vnd.uplanet.channel-wbxml"
    applicationSOLIDUSvndFULL_STOPuplanetFULL_STOPlist = "application/vnd.uplanet.list"
    applicationSOLIDUSvndFULL_STOPuplanetFULL_STOPlistcmd = "application/vnd.uplanet.listcmd"
    applicationSOLIDUSvndFULL_STOPuplanetFULL_STOPlistcmd_wbxml = "application/vnd.uplanet.listcmd-wbxml"
    applicationSOLIDUSvndFULL_STOPuplanetFULL_STOPlist_wbxml = "application/vnd.uplanet.list-wbxml"
    applicationSOLIDUSvndFULL_STOPuplanetFULL_STOPsignal = "application/vnd.uplanet.signal"
    applicationSOLIDUSvndFULL_STOPuri_map = "application/vnd.uri-map"
    applicationSOLIDUSvndFULL_STOPvalveFULL_STOPsourceFULL_STOPmaterial = "application/vnd.valve.source.material"
    ...
    applicationSOLIDUSvndFULL_STOPveraisonFULL_STOPtsm_reportPLUS_SIGNcbor = "application/vnd.veraison.tsm-report+cbor"
    applicationSOLIDUSvndFULL_STOPveraisonFULL_STOPtsm_reportPLUS_SIGNjson = "application/vnd.veraison.tsm-report+json"
    applicationSOLIDUSvndFULL_STOPverimatrixFULL_STOPvcas = "application/vnd.verimatrix.vcas"
    applicationSOLIDUSvndFULL_STOPveritoneFULL_STOPaionPLUS_SIGNjson = "application/vnd.veritone.aion+json"
    applicationSOLIDUSvndFULL_STOPveryantFULL_STOPthin = "application/vnd.veryant.thin"
    applicationSOLIDUSvndFULL_STOPvesFULL_STOPencrypted = "application/vnd.ves.encrypted"
    applicationSOLIDUSvndFULL_STOPvidsoftFULL_STOPvidconference = "application/vnd.vidsoft.vidconference"
    ...
    applicationSOLIDUSvndFULL_STOPvividenceFULL_STOPscriptfile = "application/vnd.vividence.scriptfile"
    applicationSOLIDUSvndFULL_STOPvocalshaperFULL_STOPvsp4 = "application/vnd.vocalshaper.vsp4"
    ...
    applicationSOLIDUSvndFULL_STOPwapFULL_STOPwmlscriptc = "application/vnd.wap.wmlscriptc"
    applicationSOLIDUSvndFULL_STOPwasmflowFULL_STOPwafl = "application/vnd.wasmflow.wafl"
    ...
    applicationSOLIDUSvndFULL_STOPwindowsFULL_STOPdevicepairing = "application/vnd.windows.devicepairing"
    applicationSOLIDUSvndFULL_STOPwmc = "application/vnd.wmc"
    applicationSOLIDUSvndFULL_STOPwmfFULL_STOPbootstrap = "application/vnd.wmf.bootstrap"
    applicationSOLIDUSvndFULL_STOPwolframFULL_STOPmathematica = "application/vnd.wolfram.mathematica"
    applicationSOLIDUSvndFULL_STOPwolframFULL_STOPmathematicaFULL_STOPpackage = "application/vnd.wolfram.mathematica.package"
    applicationSOLIDUSvndFULL_STOPwolframFULL_STOPplayer = "application/vnd.wolfram.player"
    ...
    applicationSOLIDUSvndFULL_STOPwrq_hp3000_labelled = "application/vnd.wrq-hp3000-labelled"
    applicationSOLIDUSvndFULL_STOPwtFULL_STOPstf = "application/vnd.wt.stf"
    applicationSOLIDUSvndFULL_STOPwvFULL_STOPcspPLUS_SIGNwbxml = "application/vnd.wv.csp+wbxml"
    applicationSOLIDUSvndFULL_STOPwvFULL_STOPcspPLUS_SIGNxml = "application/vnd.wv.csp+xml"
    applicationSOLIDUSvndFULL_STOPwvFULL_STOPsspPLUS_SIGNxml = "application/vnd.wv.ssp+xml"
    ...
    applicationSOLIDUSvndFULL_STOPxecrets_encrypted = "application/vnd.xecrets-encrypted"
    ...
    applicationSOLIDUSvndFULL_STOPyamahaFULL_STOPhv_dic = "application/vnd.yamaha.hv-dic"
    applicationSOLIDUSvndFULL_STOPyamahaFULL_STOPhv_script = "application/vnd.yamaha.hv-script"
    applicationSOLIDUSvndFULL_STOPyamahaFULL_STOPhv_voice = "application/vnd.yamaha.hv-voice"
    applicationSOLIDUSvndFULL_STOPyamahaFULL_STOPopenscoreformat = "application/vnd.yamaha.openscoreformat"
    ...
    applicationSOLIDUSvndFULL_STOPyamahaFULL_STOPremote_setup = "application/vnd.yamaha.remote-setup"
    applicationSOLIDUSvndFULL_STOPyamahaFULL_STOPsmaf_audio = "application/vnd.yamaha.smaf-audio"
    applicationSOLIDUSvndFULL_STOPyamahaFULL_STOPsmaf_phrase = "application/vnd.yamaha.smaf-phrase"
    applicationSOLIDUSvndFULL_STOPyamahaFULL_STOPthrough_ngn = "application/vnd.yamaha.through-ngn"
    applicationSOLIDUSvndFULL_STOPyamahaFULL_STOPtunnel_udpencap = "application/vnd.yamaha.tunnel-udpencap"
    applicationSOLIDUSvndFULL_STOPyaoweme = "application/vnd.yaoweme"
    applicationSOLIDUSvndFULL_STOPyellowriver_custom_menu = "application/vnd.yellowriver-custom-menu"
    ...
    applicationSOLIDUSvndFULL_STOPzzazzFULL_STOPdeckPLUS_SIGNxml = "application/vnd.zzazz.deck+xml"
    ...
    applicationSOLIDUSxcon_conference_infoPLUS_SIGNxml = "application/xcon-conference-info+xml"
    applicationSOLIDUSxcon_conference_info_diffPLUS_SIGNxml = "application/xcon-conference-info-diff+xml"
    ...
    applicationSOLIDUSxml_external_parsed_entity = "application/xml-external-parsed-entity"
    ...
    audioSOLIDUSvndFULL_STOPms_playreadyFULL_STOPmediaFULL_STOPpya = "audio/vnd.ms-playready.media.pya"
    ...
    audioSOLIDUSvndFULL_STOPpresonusFULL_STOPmultitrack = "audio/vnd.presonus.multitrack"
    ...
    audioSOLIDUSvndFULL_STOPsealedmediaFULL_STOPsoftsealFULL_STOPmpeg = "audio/vnd.sealedmedia.softseal.mpeg"
    ...
    imageSOLIDUSvndFULL_STOPairzipFULL_STOPacceleratorFULL_STOPazv = "image/vnd.airzip.accelerator.azv"
    ...
    imageSOLIDUSvndFULL_STOPfujixeroxFULL_STOPedmics_mmr = "image/vnd.fujixerox.edmics-mmr"
    imageSOLIDUSvndFULL_STOPfujixeroxFULL_STOPedmics_rlc = "image/vnd.fujixerox.edmics-rlc"
    ...
    imageSOLIDUSvndFULL_STOPsealedmediaFULL_STOPsoftsealFULL_STOPgif = "image/vnd.sealedmedia.softseal.gif"
    imageSOLIDUSvndFULL_STOPsealedmediaFULL_STOPsoftsealFULL_STOPjpg = "image/vnd.sealedmedia.softseal.jpg"
    imageSOLIDUSvndFULL_STOPsvf = "image/vnd.svf"
    imageSOLIDUSvndFULL_STOPtencentFULL_STOPtap = "image/vnd.tencent.tap"
    imageSOLIDUSvndFULL_STOPvalveFULL_STOPsourceFULL_STOPtexture = "image/vnd.valve.source.texture"
    ...
    messageSOLIDUSglobal_disposition_notification = "message/global-disposition-notification"
    ...
    modelSOLIDUSvndFULL_STOPparasolidFULL_STOPtransmitFULL_STOPbinary = "model/vnd.parasolid.transmit.binary"
    modelSOLIDUSvndFULL_STOPparasolidFULL_STOPtransmitFULL_STOPtext = "model/vnd.parasolid.transmit.text"
    modelSOLIDUSvndFULL_STOPpythaFULL_STOPpyox = "model/vnd.pytha.pyox"
    modelSOLIDUSvndFULL_STOProsetteFULL_STOPannotated_data_model = "model/vnd.rosette.annotated-data-model"
    ...
    modelSOLIDUSvndFULL_STOPvalveFULL_STOPsourceFULL_STOPcompiled_map = "model/vnd.valve.source.compiled-map"
    ...
    textSOLIDUSvndFULL_STOPesmertecFULL_STOPtheme_descriptor = "text/vnd.esmertec.theme-descriptor"
    ...
    textSOLIDUSvndFULL_STOPnet2phoneFULL_STOPcommcenterFULL_STOPcommand = "text/vnd.net2phone.commcenter.command"
    textSOLIDUSvndFULL_STOPradisysFULL_STOPmsml_basic_layout = "text/vnd.radisys.msml-basic-layout"
    ...
    textSOLIDUSvndFULL_STOPsunFULL_STOPj2meFULL_STOPapp_descriptor = "text/vnd.sun.j2me.app-descriptor"
    ...
    videoSOLIDUSvndFULL_STOPiptvforumFULL_STOP1dparityfec_1010 = "video/vnd.iptvforum.1dparityfec-1010"
    videoSOLIDUSvndFULL_STOPiptvforumFULL_STOP1dparityfec_2005 = "video/vnd.iptvforum.1dparityfec-2005"
    videoSOLIDUSvndFULL_STOPiptvforumFULL_STOP2dparityfec_1010 = "video/vnd.iptvforum.2dparityfec-1010"
    videoSOLIDUSvndFULL_STOPiptvforumFULL_STOP2dparityfec_2005 = "video/vnd.iptvforum.2dparityfec-2005"
    ...
    videoSOLIDUSvndFULL_STOPms_playreadyFULL_STOPmediaFULL_STOPpyv = "video/vnd.ms-playready.media.pyv"
    videoSOLIDUSvndFULL_STOPnokiaFULL_STOPinterleaved_multimedia = "video/vnd.nokia.interleaved-multimedia"
    ...
    videoSOLIDUSvndFULL_STOPradgamettoolsFULL_STOPsmacker = "video/vnd.radgamettools.smacker"
    ...
    videoSOLIDUSvndFULL_STOPsealedmediaFULL_STOPsoftsealFULL_STOPmov = "video/vnd.sealedmedia.softseal.mov"
...
class RepresentationVariant(ConfiguredBaseModel):
    ...
    media_type: Optional[MEDIATypes] = Field(None, description="""The media type of the representation as defined by [IANA](https://www.iana.org/assignments/media-types/media-types.xhtml)""", json_schema_extra = { "linkml_meta": {'alias': 'media_type', 'domain_of': ['RepresentationVariant']} })
